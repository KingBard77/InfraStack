...
namespace App\Controller\Tools\Cis\AssessCentos7220Cis;
...
{
    private const SCRIPT_ROOT = '/templates/content/tools/cis/assess-centos-7-220-cis/assets/bin';

    #[Route('/api/cis/assess-centos-7-220-cis/script', name: 'app_cis_assess_centos_7_220_cis_script', methods: ['POST'])]
