...
namespace App\Controller\Tools\Cis\AssessUbuntu2404Cis;
...
{
    private const SCRIPT_ROOT = '/templates/content/tools/cis/assess-ubuntu-2404-cis/assets/bin';

    #[Route('/api/cis/assess-ubuntu-2404-cis/script', name: 'app_cis_assess_ubuntu_2404_cis_script', methods: ['POST'])]
