...
namespace App\Controller\Tools\Cis\AssessAwsCompute110Cis;
...
{
    private const SCRIPT_ROOT = '/templates/content/tools/cis/assess-aws-compute-110-cis/assets/bin';

    #[Route('/api/cis/assess-aws-compute-110-cis/script', name: 'app_cis_assess_aws_compute_110_cis_script', methods: ['POST'])]
