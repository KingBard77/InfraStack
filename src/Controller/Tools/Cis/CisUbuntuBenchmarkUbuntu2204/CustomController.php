...
namespace App\Controller\Tools\Cis\CisUbuntuBenchmarkUbuntu2204;
...
{
    private const SCRIPT_ROOT = '/templates/content/tools/cis/cis-ubuntu-benchmark-ubuntu-2204/assets/bin';

    #[Route('/api/cis/cis-ubuntu-benchmark-ubuntu-2204/script', name: 'app_cis_cis_ubuntu_benchmark_ubuntu_2204_script', methods: ['POST'])]
