...
namespace App\Controller\Tools\Cis\AssessNginx300Cis;
...
{
    private const SCRIPT_ROOT = '/templates/content/tools/cis/assess-nginx-300-cis/assets/bin';

    #[Route('/api/cis/assess-nginx-300-cis/script', name: 'app_cis_assess_nginx_300_cis_script', methods: ['POST'])]
