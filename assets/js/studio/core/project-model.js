const InfraStackStudioCore = (function () {
    ...
    function normalizeConnections(value, assetIds) {
        ...
        return (Array.isArray(value) ? value : []).reduce(function (connections, connection) {
            ...
            connections.push({
                ...
                direction: safeString(connection.direction || (connection.bidirectional ? 'bidirectional' : 'source-to-target'), 30),
    ...
    function updateConnection(project, connectionId, changes) {
        ...
        connection.type = connectionTypes.includes(changes.type) ? changes.type : connection.type;
        if (Object.hasOwn(changes, 'label')) connection.label = safeString(changes.label, 80);
        if (Object.hasOwn(changes, 'bidirectional')) connection.bidirectional = changes.bidirectional === true;
        if (Object.hasOwn(changes, 'direction')) connection.direction = safeString(changes.direction, 30);
        ...
        if (!connection.direction) connection.direction = connection.bidirectional ? 'bidirectional' : 'source-to-target';
        next.updated_at = new Date().toISOString();
...
if (typeof globalThis !== 'undefined') {
    globalThis.InfraStackStudioCore = InfraStackStudioCore;
}

if (typeof module !== 'undefined' && module.exports) {
    module.exports = InfraStackStudioCore;
}
