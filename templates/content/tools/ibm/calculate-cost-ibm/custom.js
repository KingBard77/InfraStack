...
installInfraStackResultSummaryNormalizer('calculate-cost-ibm');
...
// ns:end family._base.workspace.03_custom-settings
    ...
    const sortOptionButtons = Array.from(document.querySelectorAll('.calculate-cost-ibm-sort-option'));
        ...
        if (query.includeCompute) {
            if (query.computeInstance === 'custom') {
                ...
                if (query.overrides.computeHourly === null) {
                    return 'Set VSI hourly override in Custom when using Custom size.';
                }
    ...
    function buildSummaryHtml(result) {
        ...
        return `
            <header class="calculate-cost-ibm-result-header" aria-label="Result summary header">
                <div class="calculate-cost-ibm-result-header-main">
                    <span class="calculate-cost-ibm-result-header-icon" aria-hidden="true"><i class="bi bi-calculator"></i></span>
                    <div class="calculate-cost-ibm-result-header-copy">
                        <h2 class="calculate-cost-ibm-result-header-title">Result Summary</h2>
                        <p>Overview of the current IBM Cloud estimate result and key metrics</p>
                    </div>
                </div>
                <div class="calculate-cost-ibm-result-header-meta" aria-label="Result summary status">
                    <span class="calculate-cost-ibm-result-header-chip calculate-cost-ibm-result-chip-ready"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-circle-fill"></i></span><span>Estimated</span></span>
                    <span class="calculate-cost-ibm-result-header-chip calculate-cost-ibm-result-chip-updated"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-calendar3"></i></span><span>${escapeHtml(generatedAtText)}</span></span>
                </div>
            </header>

            <div class="calculate-cost-ibm-result-hero-grid" aria-live="polite">
                <article class="calculate-cost-ibm-result-card calculate-cost-ibm-result-card-primary" data-result-visual="ring" aria-label="Primary estimate result">
                    <div class="calculate-cost-ibm-result-primary-heading calculate-cost-ibm-result-visual-copy calculate-cost-ibm-result-visual-copy-top"><div class="calculate-cost-ibm-result-kicker">Primary Result</div><h3 class="calculate-cost-ibm-result-title calculate-cost-ibm-result-title-center">Estimated run rate</h3></div>
                    <div class="calculate-cost-ibm-result-primary-visual" id="calculateCostIbmResultVisual" aria-label="Primary estimate result visual">
                        <span class="calculate-cost-ibm-result-card-icon calculate-cost-ibm-result-card-icon-primary" aria-hidden="true"><i class="bi bi-cash-coin"></i></span>
                        <div class="calculate-cost-ibm-result-ring calculate-cost-ibm-spend-ring" id="calculateCostIbmSpendRing" style="--calculate-cost-ibm-result-progress: ${escapeHtml(String(progressAngle))}deg; --progress-angle: ${escapeHtml(String(progressAngle))}deg; --calculate-cost-ibm-result-value-chars: ${escapeHtml(String(primaryValueChars))};" aria-label="Estimated monthly IBM Cloud run rate ${escapeHtml(monthlyTotal)}">
                            <div class="calculate-cost-ibm-spend-chart" id="calculateCostIbmSpendChart" aria-hidden="true"></div>
                            <div class="calculate-cost-ibm-result-ring-center calculate-cost-ibm-spend-value">
                                <strong class="calculate-cost-ibm-result-ring-value">${escapeHtml(monthlyTotal)}</strong>
                                <span class="calculate-cost-ibm-result-ring-unit">Monthly</span>
                            </div>
                        </div>
                    </div>
                    <div class="calculate-cost-ibm-result-visual-copy">
                        <p class="calculate-cost-ibm-result-copy calculate-cost-ibm-result-copy-center">Modeled monthly total from the current assumptions.</p>
                    </div>
                    <span class="calculate-cost-ibm-result-card-divider" aria-hidden="true"></span>
                    <div class="calculate-cost-ibm-result-chip-row calculate-cost-ibm-result-chip-row-center" aria-label="Primary result outcome">
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-outcome calculate-cost-ibm-result-chip-ready"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-cash-coin"></i></span><span>Monthly Estimate</span></span>
                    </div>
                </article>

                <article class="calculate-cost-ibm-result-card calculate-cost-ibm-result-card-summary" aria-label="Estimate summary">
                    <div class="calculate-cost-ibm-result-summary-intro">
                        <span class="calculate-cost-ibm-result-card-icon calculate-cost-ibm-result-card-icon-summary" aria-hidden="true"><i class="bi bi-receipt"></i></span>
                        <div class="calculate-cost-ibm-result-summary-copy">
                            <div class="calculate-cost-ibm-result-kicker">Descriptive Summary</div>
                            <h3 class="calculate-cost-ibm-result-title">IBM Cloud run-rate estimate</h3>
                            <p class="calculate-cost-ibm-result-copy">Top driver: ${escapeHtml(topDriver)}. Totals are derived from the current assumptions, visible overrides, and generated service mix.</p>
                        </div>
                    </div>
                    <span class="calculate-cost-ibm-result-card-divider" aria-hidden="true"></span>
                    <div class="calculate-cost-ibm-result-chip-grid" aria-label="Estimate state">
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-ready"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-check2-circle"></i></span><span>${escapeHtml(presetLabel)}</span></span>
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-baseline"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-grid-3x3-gap"></i></span><span>${escapeHtml(String(activeServices))} services</span></span>
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-${overrideTone}"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-sliders"></i></span><span>${escapeHtml(String(overrideCount))} overrides</span></span>
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-baseline"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-graph-up-arrow"></i></span><span>Top driver: ${escapeHtml(topDriver)}</span></span>
                        <span class="calculate-cost-ibm-result-chip calculate-cost-ibm-result-chip-warning"><span class="calculate-cost-ibm-result-chip-icon" aria-hidden="true"><i class="bi bi-hdd-network"></i></span><span>Egress: ${escapeHtml(combinedEgress)}</span></span>
                    </div>
                </article>
            </div>

            <div class="calculate-cost-ibm-result-metric-grid" aria-label="Estimate metrics">
                <article class="calculate-cost-ibm-result-metric-card calculate-cost-ibm-result-metric-success">
                    <span class="calculate-cost-ibm-result-metric-icon" aria-hidden="true"><i class="bi bi-calendar2-check"></i></span>
                    <span class="calculate-cost-ibm-result-metric-label">Annual</span>
                    <strong class="calculate-cost-ibm-result-metric-value">${escapeHtml(formatCurrency(result.totals.annualTotal))}</strong>
                    <span class="calculate-cost-ibm-result-metric-copy">Projected from the current monthly run rate.</span>
                    <span class="calculate-cost-ibm-result-metric-accent" aria-hidden="true"></span>
                </article>
                <article class="calculate-cost-ibm-result-metric-card calculate-cost-ibm-result-metric-info">
                    <span class="calculate-cost-ibm-result-metric-icon" aria-hidden="true"><i class="bi bi-sun"></i></span>
                    <span class="calculate-cost-ibm-result-metric-label">Daily</span>
                    <strong class="calculate-cost-ibm-result-metric-value">${escapeHtml(formatCurrency(result.totals.dailyTotal))}</strong>
                    <span class="calculate-cost-ibm-result-metric-copy">Thirty-day planning average.</span>
                    <span class="calculate-cost-ibm-result-metric-accent" aria-hidden="true"></span>
                </article>
                <article class="calculate-cost-ibm-result-metric-card calculate-cost-ibm-result-metric-accent-tone">
                    <span class="calculate-cost-ibm-result-metric-icon" aria-hidden="true"><i class="bi bi-clock"></i></span>
                    <span class="calculate-cost-ibm-result-metric-label">Hourly</span>
                    <strong class="calculate-cost-ibm-result-metric-value">${escapeHtml(formatCurrency(result.totals.hourlyTotal))}</strong>
                    <span class="calculate-cost-ibm-result-metric-copy">Useful for long-running workload checks.</span>
                    <span class="calculate-cost-ibm-result-metric-accent" aria-hidden="true"></span>
                </article>
                <article class="calculate-cost-ibm-result-metric-card calculate-cost-ibm-result-metric-warning">
                    <span class="calculate-cost-ibm-result-metric-icon" aria-hidden="true"><i class="bi bi-hdd-network"></i></span>
                    <span class="calculate-cost-ibm-result-metric-label">Egress</span>
                    <strong class="calculate-cost-ibm-result-metric-value">${escapeHtml(combinedEgress)}</strong>
                    <span class="calculate-cost-ibm-result-metric-copy">Combined modeled outbound traffic.</span>
                    <span class="calculate-cost-ibm-result-metric-accent" aria-hidden="true"></span>
                </article>
            </div>
        `;
    ...
    function buildBreakdownRow(item, index) {
        return `
            <tr>
                ...
                <td class="calculate-cost-ibm-copy-cell tool-table-action-cell">
    ...
    function renderResult(result) {
        destroySpendRingChart();
        resultSummary.classList.add('calculate-cost-ibm-result-summary');
...
(function setupCalculateCostIbmTableOutputStandard() {
    const rootSelector = '.calculate-cost-ibm-tool';
    const tableSelector = '.tool-result-table tbody tr, .calculate-cost-ibm-table tbody tr';
    const tbodySelector = '.tool-result-table tbody, .calculate-cost-ibm-table tbody';
    const clampClass = 'calculate-cost-ibm-table-cell-text';
    const cellClampClass = 'calculate-cost-ibm-cell-clamp';
    const statusColumnClass = 'calculate-cost-ibm-table-status-cell';
    ...
    function applyStatusAlignment(root) {
        root.querySelectorAll('.tool-result-table, .calculate-cost-ibm-table').forEach(function alignStatusTable(table) {
