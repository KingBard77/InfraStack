const GcpVpcModelCore = (function () {
    const toolId = 'gcp-vpc-topology';
    ...
    function buildImportedPayloadState(payload, presets) {
        ...
        if (payload.tool !== toolId) {
            return {
                error: 'The imported JSON is not a Visualizer GCP VPC Topology workspace export.'
            };
        }
...
if (typeof globalThis !== 'undefined') {
    globalThis.GcpVpcModelCore = GcpVpcModelCore;
}

if (typeof module !== 'undefined' && module.exports) {
    module.exports = GcpVpcModelCore;
}
