...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-overview">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-compass" aria-hidden="true"></i><span>Overview</span></h2>

CIS Ubuntu Benchmark 2404 is an InfraStack assessment workspace for browsing the copied Ubuntu 24.04 CIS benchmark script tree. It turns the local <code>assets/bin/</code> inventory into a searchable review surface for <span class="assess-ubuntu-2404-cis-term-accent">control IDs</span>, <span class="assess-ubuntu-2404-cis-term-accent">section paths</span>, declared <span class="assess-ubuntu-2404-cis-term-accent">CRITICALITY</span>, selected shell bodies, and exportable inventory snapshots. <a id="assess-ubuntu-2404-cis-cite-primary" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-primary"><span class="assess-ubuntu-2404-cis-citation-inline">Center for Internet Security (n.d.-a)</span></a> publishes the Ubuntu Linux benchmark family, so this workspace cites CIS as the benchmark source while keeping the local script inventory as the reviewed artifact.

<a id="assess-ubuntu-2404-cis-cite-method" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-method"><span class="assess-ubuntu-2404-cis-citation-inline">Canonical (2024)</span></a> identifies Ubuntu 24.04 LTS as Noble Numbat and documents its support lifecycle, which anchors the Ubuntu release scope used by this tool.

<a id="assess-ubuntu-2404-cis-cite-review" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-review"><span class="assess-ubuntu-2404-cis-citation-inline">Center for Internet Security (n.d.-b)</span></a> documents CIS-CAT Pro Assessor as a tool for comparing target system settings against CIS Benchmarks, so this browser workspace stays honest: it organizes copied controls but does not assess a live host.
...
- Browse 312 copied CIS control scripts without walking the folder tree manually
...
<div class="assess-ubuntu-2404-cis-markdown-table-wrap">
<table>
  <thead>
    <tr>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-technical">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-card-checklist" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The technical scope stays tied to benchmark and operating-system sources. <a id="assess-ubuntu-2404-cis-cite-technical-primary" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-primary"><span class="assess-ubuntu-2404-cis-citation-inline">Center for Internet Security (n.d.-a)</span></a> anchors the benchmark family, <a id="assess-ubuntu-2404-cis-cite-technical-method" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-method"><span class="assess-ubuntu-2404-cis-citation-inline">Canonical (2024)</span></a> anchors the Ubuntu 24.04 LTS release scope, and <a id="assess-ubuntu-2404-cis-cite-technical-review" class="assess-ubuntu-2404-cis-citation-link" href="#assess-ubuntu-2404-cis-ref-review"><span class="assess-ubuntu-2404-cis-citation-inline">Center for Internet Security (n.d.-b)</span></a> keeps the boundary clear between a browser catalogue and a live host assessment.
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">1. Copied benchmark inventory</h3>

The catalogue is generated from the copied scripts under <code>templates/content/tools/cis/assess-ubuntu-2404-cis/assets/bin/</code> and embedded through <code>assets/custom.json.twig</code>. The current inventory describes 312 shell scripts across 73 section paths and 7 top-level families.

<h3 class="assess-ubuntu-2404-cis-technical-step-heading">2. Filter and URL state</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">3. Selected script loading</h3>

The script body is not embedded into the catalogue payload. When a script is selected, the browser posts the relative script path to the Symfony endpoint at <code>/api/cis/assess-ubuntu-2404-cis/script</code>. The endpoint normalizes the path, rejects traversal, limits reads to <code>.sh</code> files under <code>assets/bin/</code>, and returns the selected source body.

<h3 class="assess-ubuntu-2404-cis-technical-step-heading">4. Metadata limits</h3>

The copied scripts declare <code>CRITICALITY</code> values that the workspace renders as review labels. The current Ubuntu 24.04 inventory includes level 1 and level 2 controls; if a future copied script omits that value, the workspace labels it as unspecified so the gap stays visible. It does not infer severity, remap controls, or certify benchmark coverage.

<h3 class="assess-ubuntu-2404-cis-technical-step-heading">5. How to read the catalogue</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">7. Script body handling</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">8. Assessment boundaries</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">9. Export and handoff behavior</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">10. Human review workflow</h3>
...
Next, separate catalogue completeness from host readiness. An omitted criticality value in a future copied script would be a catalogue issue. A failed package check is a host issue. An approved exception is a governance issue. The workspace can help keep those categories separate by showing filters, sections, selected script content, and export payloads in one place.

<h3 class="assess-ubuntu-2404-cis-technical-step-heading">11. Practical review checklist</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">12. Change-control context</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">13. Evidence and exception handling</h3>
...
<h3 class="assess-ubuntu-2404-cis-technical-step-heading">14. Result and export model</h3>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-example-commands">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-terminal" aria-hidden="true"></i><span>Example Commands</span></h2>
...
<pre class="assess-ubuntu-2404-cis-command-example-pre"><code class="language-bash">vi script.sh</code></pre>

<details class="cisbench-command-note assess-ubuntu-2404-cis-command-note" open>
  <summary>
    ...
    <button type="button" class="assess-ubuntu-2404-cis-command-copy-btn" data-command-copy-index="0">
...
<pre class="assess-ubuntu-2404-cis-command-example-pre"><code class="language-bash">#!/bin/bash
...
<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-ubuntu-2404-cis-command-copy-btn" data-command-copy-index="1">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
...
<pre class="assess-ubuntu-2404-cis-command-example-pre"><code class="language-bash">chmod +x script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-ubuntu-2404-cis-command-copy-btn" data-command-copy-index="2">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
...
<pre class="assess-ubuntu-2404-cis-command-example-pre"><code class="language-bash">./script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-ubuntu-2404-cis-command-copy-btn" data-command-copy-index="3">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-prompt-tips assess-ubuntu-2404-cis-markdown-card-input-tips">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-lightbulb" aria-hidden="true"></i><span>Input Tips</span></h2>
...
<li>Run copied scripts manually on an appropriate Ubuntu 24.04 host, with your own backup, rollback, and change-control process.</li>
</ul>
</div>
</details>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-how-to">
  <h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-list-check assess-ubuntu-2404-cis-section-heading-icon" aria-hidden="true"></i><span>How To Use</span></h2>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-export">
  <h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-download assess-ubuntu-2404-cis-section-heading-icon" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-faq">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-question-circle" aria-hidden="true"></i><span>FAQ</span></h2>
...
<details class="faq-item">
  ...
  <div class="faq-answer">
    Yes. Import JSON restores exported filter state, selected control, sort, and row limit. It does not prove host state or preserve live execution evidence.
  </div>
</details>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-acronyms">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-type" aria-hidden="true"></i><span>Acronyms</span></h2>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The copied script tree follows the local Ubuntu 24.04 benchmark package organization used by this workspace.</td>
    </tr>
    <tr>
      <td>Control ID</td>
...
<div class="content-card assess-ubuntu-2404-cis-markdown-card assess-ubuntu-2404-cis-markdown-card-citations">

<h2 class="assess-ubuntu-2404-cis-section-heading"><i class="bi bi-journal-text" aria-hidden="true"></i><span>References</span></h2>

<p>These sources support the in-text citations used in this tool page.</p>

<table class="assess-ubuntu-2404-cis-citation-table">
  <thead>
    <tr>
      <th>Source type</th>
  ...
  <tbody>
    <tr id="assess-ubuntu-2404-cis-ref-primary">
      <td>Benchmark website</td>
      <td><a class="assess-ubuntu-2404-cis-citation-backlink" href="#assess-ubuntu-2404-cis-cite-primary"><span class="assess-ubuntu-2404-cis-citation-inline">(Center for Internet Security, n.d.-a)</span></a></td>
      <td>Center for Internet Security. (n.d.-a). <em>Ubuntu Linux Benchmarks</em>. Retrieved June 2, 2026, from <a href="https://www.cisecurity.org/benchmark/ubuntu_linux">https://www.cisecurity.org/benchmark/ubuntu_linux</a></td>
    </tr>
    <tr id="assess-ubuntu-2404-cis-ref-method">
      <td>Release notes</td>
      <td><a class="assess-ubuntu-2404-cis-citation-backlink" href="#assess-ubuntu-2404-cis-cite-method"><span class="assess-ubuntu-2404-cis-citation-inline">(Canonical, 2024)</span></a></td>
      <td>Canonical. (2024, April 11). <em>Ubuntu 24.04 LTS (Noble Numbat) Release Notes</em>. Ubuntu Community Hub. <a href="https://discourse.ubuntu.com/t/noble-numbat-release-notes/39890">https://discourse.ubuntu.com/t/noble-numbat-release-notes/39890</a></td>
    </tr>
    <tr id="assess-ubuntu-2404-cis-ref-review">
      <td>Assessment tool website</td>
      <td><a class="assess-ubuntu-2404-cis-citation-backlink" href="#assess-ubuntu-2404-cis-cite-review"><span class="assess-ubuntu-2404-cis-citation-inline">(Center for Internet Security, n.d.-b)</span></a></td>
