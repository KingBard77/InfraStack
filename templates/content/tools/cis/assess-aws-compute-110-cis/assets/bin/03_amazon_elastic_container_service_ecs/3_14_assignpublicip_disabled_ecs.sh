...
function check {
    ...
    ecs_services_with_query 'services[?networkConfiguration.awsvpcConfiguration.assignPublicIp!=`DISABLED`].serviceName' 'ECS task sets or services with public IP assignment enabled'
