...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-overview">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-compass" aria-hidden="true"></i><span>Overview</span></h2>

CIS NGINX Benchmark 3.0.0 is an InfraStack assessment workspace for browsing the copied NGINX CIS benchmark script tree. It turns the local <code>assets/bin/</code> inventory into a searchable review surface for <span class="assess-nginx-300-cis-term-accent">control IDs</span>, <span class="assess-nginx-300-cis-term-accent">section paths</span>, declared <span class="assess-nginx-300-cis-term-accent">CRITICALITY</span>, selected shell bodies, and exportable inventory snapshots. <a id="assess-nginx-300-cis-cite-primary" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-primary"><span class="assess-nginx-300-cis-citation-inline">Center for Internet Security (2026)</span></a> announced CIS NGINX Benchmark v3.0.0, which anchors the benchmark version represented by this copied script tree, while the local script inventory remains the artifact reviewed by this tool.

<a id="assess-nginx-300-cis-cite-method" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-method"><span class="assess-nginx-300-cis-citation-inline">NGINX (n.d.)</span></a> publishes product documentation for NGINX configuration and modules, which is the product context behind the local script review.

<a id="assess-nginx-300-cis-cite-review" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-review"><span class="assess-nginx-300-cis-citation-inline">Center for Internet Security (n.d.)</span></a> documents CIS-CAT Pro Assessor as tooling for comparing target settings against CIS Benchmarks, which keeps this browser catalogue separate from live assessment.

The workspace is read-only. It does not run benchmark checks, apply fixes, connect to targets, or prove compliance. Use it to find the right control script, inspect the source body, copy or download it, and then decide how to test or run it in a controlled NGINX shell or configuration review workflow.

Use it when you need to:

- Browse 44 copied CIS control scripts without walking the folder tree manually
...
<div class="assess-nginx-300-cis-markdown-table-wrap">
<table>
  <thead>
    <tr>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-technical">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-card-checklist" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The technical scope stays tied to benchmark and target-platform sources. <a id="assess-nginx-300-cis-cite-technical-primary" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-primary"><span class="assess-nginx-300-cis-citation-inline">Center for Internet Security (2026)</span></a> anchors the benchmark family, <a id="assess-nginx-300-cis-cite-technical-method" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-method"><span class="assess-nginx-300-cis-citation-inline">NGINX (n.d.)</span></a> anchors the NGINX context, and <a id="assess-nginx-300-cis-cite-technical-review" class="assess-nginx-300-cis-citation-link" href="#assess-nginx-300-cis-ref-review"><span class="assess-nginx-300-cis-citation-inline">Center for Internet Security (n.d.)</span></a> keeps the boundary clear between a browser catalogue and a live target assessment.
...
<h3 class="assess-nginx-300-cis-technical-step-heading">1. Copied benchmark inventory</h3>

The catalogue is generated from the copied scripts under <code>templates/content/tools/cis/assess-nginx-300-cis/assets/bin/</code> and embedded through <code>assets/custom.json.twig</code>. The current inventory describes 44 shell scripts across 16 section paths and 5 top-level families.

<h3 class="assess-nginx-300-cis-technical-step-heading">2. Filter and URL state</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">3. Selected script loading</h3>

The script body is not embedded into the catalogue payload. When a script is selected, the browser posts the relative script path to the Symfony endpoint at <code>/api/cis/assess-nginx-300-cis/script</code>. The endpoint normalizes the path, rejects traversal, limits reads to <code>.sh</code> files under <code>assets/bin/</code>, and returns the selected source body.

<h3 class="assess-nginx-300-cis-technical-step-heading">4. Metadata limits</h3>

The copied scripts declare <code>CRITICALITY</code> values that the workspace renders as review labels. The current NGINX inventory includes level 1 and level 2 controls; if a future copied script omits that value, the workspace labels it as unspecified so the gap stays visible. It does not infer severity, remap controls, or certify benchmark coverage.

<h3 class="assess-nginx-300-cis-technical-step-heading">5. How to read the catalogue</h3>

Read this workspace as a navigation and review layer over a local script set. It helps you find controls, inspect script bodies, group sections, compare metadata, and export a filtered view. It does not decide whether a NGINX host is hardened. It does not execute benchmark scripts. It does not inspect live settings, credentials, services, packages, users, files, cloud resources, or running configuration on a target.
...
<h3 class="assess-nginx-300-cis-technical-step-heading">6. Filter discipline</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">7. Script body handling</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">8. Assessment boundaries</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">9. Export and handoff behavior</h3>
...
When handing off a filtered set, include the target context outside the export: NGINX host and configuration tree, environment, exception policy, maintenance window, reviewer, and evidence location. If a control will be executed, pair the copied script with a test plan and rollback plan. If a control is informational, pair it with the evidence expected from the target.

<h3 class="assess-nginx-300-cis-technical-step-heading">10. Human review workflow</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">11. Practical review checklist</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">12. Change-control context</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">13. Evidence and exception handling</h3>
...
<h3 class="assess-nginx-300-cis-technical-step-heading">14. Result and export model</h3>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-example-commands">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-terminal" aria-hidden="true"></i><span>Example Commands</span></h2>

<p>These examples show the shell workflow for taking a copied CIS control script from the Script tab and running it manually in a controlled NGINX shell or configuration review workflow.</p>

<pre class="assess-nginx-300-cis-command-example-pre"><code class="language-bash">vi script.sh</code></pre>

<details class="cisbench-command-note assess-nginx-300-cis-command-note" open>
  <summary>
    ...
    <button type="button" class="assess-nginx-300-cis-command-copy-btn" data-command-copy-index="0">
...
<pre class="assess-nginx-300-cis-command-example-pre"><code class="language-bash">#!/bin/bash
...
<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-nginx-300-cis-command-copy-btn" data-command-copy-index="1">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
...
<pre class="assess-nginx-300-cis-command-example-pre"><code class="language-bash">chmod +x script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-nginx-300-cis-command-copy-btn" data-command-copy-index="2">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
...
<pre class="assess-nginx-300-cis-command-example-pre"><code class="language-bash">./script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-nginx-300-cis-command-copy-btn" data-command-copy-index="3">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
  <div class="alert alert-warning d-flex align-items-start gap-3 mb-0" role="alert">
    ...
    <div><strong>Execute:</strong> Run the copied CIS control script only in the approved controlled NGINX shell or configuration review workflow, then review its output before deciding whether to apply fixes.</div>
  </div>
</details>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-prompt-tips assess-nginx-300-cis-markdown-card-input-tips">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-lightbulb" aria-hidden="true"></i><span>Input Tips</span></h2>
...
<li>Search by title terms such as <code>tls</code>, <code>logging</code>, <code>server_tokens</code>, <code>csp</code>, <code>headers</code>.</li>
...
<li>Run copied scripts manually against an approved NGINX host and configuration tree, with your own backup, rollback, and change-control process.</li>
</ul>
</div>
</details>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-how-to">
  <h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-list-check assess-nginx-300-cis-section-heading-icon" aria-hidden="true"></i><span>How To Use</span></h2>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-export">
  <h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-download assess-nginx-300-cis-section-heading-icon" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-faq">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-question-circle" aria-hidden="true"></i><span>FAQ</span></h2>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-acronyms">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-type" aria-hidden="true"></i><span>Acronyms</span></h2>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The copied script tree follows the local NGINX benchmark package organization used by this workspace.</td>
    </tr>
    <tr>
      <td>Control ID</td>
      <td>The benchmark identifier derived from a copied script filename, such as <code>1.1.1</code>.</td>
...
<div class="content-card assess-nginx-300-cis-markdown-card assess-nginx-300-cis-markdown-card-citations">

<h2 class="assess-nginx-300-cis-section-heading"><i class="bi bi-journal-text" aria-hidden="true"></i><span>References</span></h2>

<p>These sources support the in-text citations used in this tool page.</p>

<table class="assess-nginx-300-cis-citation-table">
  <thead>
    <tr>
      <th>Source type</th>
  ...
  <tbody>
    <tr id="assess-nginx-300-cis-ref-primary">
      <td>Benchmark update</td>
      <td><a class="assess-nginx-300-cis-citation-backlink" href="#assess-nginx-300-cis-cite-primary"><span class="assess-nginx-300-cis-citation-inline">(Center for Internet Security (2026))</span></a></td>
      <td>Center for Internet Security. (2026, January 31). <em>CIS Benchmarks January 2026 Update</em>. <a href="https://www.cisecurity.org/insights/blog/cis-benchmarks-january-2026-update">https://www.cisecurity.org/insights/blog/cis-benchmarks-january-2026-update</a></td>
    </tr>
    <tr id="assess-nginx-300-cis-ref-method">
      <td>Product documentation</td>
      <td><a class="assess-nginx-300-cis-citation-backlink" href="#assess-nginx-300-cis-cite-method"><span class="assess-nginx-300-cis-citation-inline">(NGINX (n.d.))</span></a></td>
      <td>NGINX. (n.d.). <em>nginx documentation</em>. Retrieved June 2, 2026, from <a href="https://nginx.org/en/docs/">https://nginx.org/en/docs/</a></td>
    </tr>
    <tr id="assess-nginx-300-cis-ref-review">
      <td>Assessment tool documentation</td>
      <td><a class="assess-nginx-300-cis-citation-backlink" href="#assess-nginx-300-cis-cite-review"><span class="assess-nginx-300-cis-citation-inline">(Center for Internet Security (n.d.))</span></a></td>
      <td>Center for Internet Security. (n.d.). <em>About CIS-CAT Pro Assessor v4</em>. Retrieved June 2, 2026, from <a href="https://ciscat-assessor.docs.cisecurity.org/en/latest/About/">https://ciscat-assessor.docs.cisecurity.org/en/latest/About/</a></td>
    </tr>
  </tbody>
</table>
