...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-overview">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-compass" aria-hidden="true"></i><span>Overview</span></h2>

CIS CentOS Linux 7 Benchmark 2.2.0 is an InfraStack assessment workspace for browsing the copied CentOS Linux 7 CIS benchmark script tree. It turns the local <code>assets/bin/</code> inventory into a searchable review surface for <span class="assess-centos-7-220-cis-term-accent">control IDs</span>, <span class="assess-centos-7-220-cis-term-accent">section paths</span>, declared <span class="assess-centos-7-220-cis-term-accent">CRITICALITY</span>, selected shell bodies, and exportable inventory snapshots. <a id="assess-centos-7-220-cis-cite-primary" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-primary"><span class="assess-centos-7-220-cis-citation-inline">Center for Internet Security (n.d.-a)</span></a> describes CIS Benchmarks as consensus-based secure configuration guides, which frames the copied benchmark tree as guidance material rather than host proof, while the local script inventory remains the artifact reviewed by this tool.

<a id="assess-centos-7-220-cis-cite-method" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-method"><span class="assess-centos-7-220-cis-citation-inline">The CentOS Project (n.d.)</span></a> states that CentOS Linux 7 reached end of life on June 30, 2024, which makes release context and exception handling important for any review.

<a id="assess-centos-7-220-cis-cite-review" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-review"><span class="assess-centos-7-220-cis-citation-inline">Center for Internet Security (n.d.-b)</span></a> documents CIS-CAT Pro Assessor as tooling for comparing target settings against CIS Benchmarks, which keeps this browser catalogue separate from live assessment.

The workspace is read-only. It does not run benchmark checks, apply fixes, connect to targets, or prove compliance. Use it to find the right control script, inspect the source body, copy or download it, and then decide how to test or run it in a controlled CentOS shell.

Use it when you need to:

- Browse 191 copied CIS control scripts without walking the folder tree manually
...
<div class="assess-centos-7-220-cis-markdown-table-wrap">
<table>
  <thead>
    <tr>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-technical">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-card-checklist" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The technical scope stays tied to benchmark and target-platform sources. <a id="assess-centos-7-220-cis-cite-technical-primary" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-primary"><span class="assess-centos-7-220-cis-citation-inline">Center for Internet Security (n.d.-a)</span></a> anchors the benchmark family, <a id="assess-centos-7-220-cis-cite-technical-method" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-method"><span class="assess-centos-7-220-cis-citation-inline">The CentOS Project (n.d.)</span></a> anchors the CentOS Linux 7 context, and <a id="assess-centos-7-220-cis-cite-technical-review" class="assess-centos-7-220-cis-citation-link" href="#assess-centos-7-220-cis-ref-review"><span class="assess-centos-7-220-cis-citation-inline">Center for Internet Security (n.d.-b)</span></a> keeps the boundary clear between a browser catalogue and a live target assessment.
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">1. Copied benchmark inventory</h3>

The catalogue is generated from the copied scripts under <code>templates/content/tools/cis/assess-centos-7-220-cis/assets/bin/</code> and embedded through <code>assets/custom.json.twig</code>. The current inventory describes 191 shell scripts across 29 section paths and 6 top-level families.

<h3 class="assess-centos-7-220-cis-technical-step-heading">2. Filter and URL state</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">3. Selected script loading</h3>

The script body is not embedded into the catalogue payload. When a script is selected, the browser posts the relative script path to the Symfony endpoint at <code>/api/cis/assess-centos-7-220-cis/script</code>. The endpoint normalizes the path, rejects traversal, limits reads to <code>.sh</code> files under <code>assets/bin/</code>, and returns the selected source body.

<h3 class="assess-centos-7-220-cis-technical-step-heading">4. Metadata limits</h3>

The copied scripts declare <code>CRITICALITY</code> values that the workspace renders as review labels. The current CentOS Linux 7 inventory includes level 1 controls; if a future copied script omits that value, the workspace labels it as unspecified so the gap stays visible. It does not infer severity, remap controls, or certify benchmark coverage.

<h3 class="assess-centos-7-220-cis-technical-step-heading">5. How to read the catalogue</h3>

Read this workspace as a navigation and review layer over a local script set. It helps you find controls, inspect script bodies, group sections, compare metadata, and export a filtered view. It does not decide whether a CentOS 7 host is hardened. It does not execute benchmark scripts. It does not inspect live settings, credentials, services, packages, users, files, cloud resources, or running configuration on a target.
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">6. Filter discipline</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">7. Script body handling</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">8. Assessment boundaries</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">9. Export and handoff behavior</h3>
...
When handing off a filtered set, include the target context outside the export: CentOS Linux 7 host, environment, exception policy, maintenance window, reviewer, and evidence location. If a control will be executed, pair the copied script with a test plan and rollback plan. If a control is informational, pair it with the evidence expected from the target.

<h3 class="assess-centos-7-220-cis-technical-step-heading">10. Human review workflow</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">11. Practical review checklist</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">12. Change-control context</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">13. Evidence and exception handling</h3>
...
<h3 class="assess-centos-7-220-cis-technical-step-heading">14. Result and export model</h3>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-example-commands">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-terminal" aria-hidden="true"></i><span>Example Commands</span></h2>

<p>These examples show the shell workflow for taking a copied CIS control script from the Script tab and running it manually in a controlled CentOS shell.</p>

<pre class="assess-centos-7-220-cis-command-example-pre"><code class="language-bash">vi script.sh</code></pre>

<details class="cisbench-command-note assess-centos-7-220-cis-command-note" open>
  <summary>
    ...
    <button type="button" class="assess-centos-7-220-cis-command-copy-btn" data-command-copy-index="0">
...
<pre class="assess-centos-7-220-cis-command-example-pre"><code class="language-bash">#!/bin/sh
...
<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-centos-7-220-cis-command-copy-btn" data-command-copy-index="1">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
...
<pre class="assess-centos-7-220-cis-command-example-pre"><code class="language-bash">chmod +x script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-centos-7-220-cis-command-copy-btn" data-command-copy-index="2">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
...
<pre class="assess-centos-7-220-cis-command-example-pre"><code class="language-bash">./script.sh</code></pre>

<details class="cisbench-command-note">
  <summary>
    <span class="cisbench-command-note-label cisbench-command-note-label-closed">Show use</span>
    <span class="cisbench-command-note-label cisbench-command-note-label-open">Hide use</span>
    <button type="button" class="assess-centos-7-220-cis-command-copy-btn" data-command-copy-index="3">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy command</span>
    </button>
  </summary>
  <div class="alert alert-warning d-flex align-items-start gap-3 mb-0" role="alert">
    ...
    <div><strong>Execute:</strong> Run the copied CIS control script only in the approved controlled CentOS shell, then review its output before deciding whether to apply fixes.</div>
  </div>
</details>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-prompt-tips assess-centos-7-220-cis-markdown-card-input-tips">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-lightbulb" aria-hidden="true"></i><span>Input Tips</span></h2>
...
<li>Search by title terms such as <code>auditd</code>, <code>ssh</code>, <code>iptables</code>, <code>vsftpd</code>, <code>pam</code>.</li>
...
<li>Run copied scripts manually against an approved CentOS Linux 7 host, with your own backup, rollback, and change-control process.</li>
</ul>
</div>
</details>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-how-to">
  <h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-list-check assess-centos-7-220-cis-section-heading-icon" aria-hidden="true"></i><span>How To Use</span></h2>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-export">
  <h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-download assess-centos-7-220-cis-section-heading-icon" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-faq">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-question-circle" aria-hidden="true"></i><span>FAQ</span></h2>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-acronyms">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-type" aria-hidden="true"></i><span>Acronyms</span></h2>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The copied script tree follows the local CentOS Linux 7 benchmark package organization used by this workspace.</td>
    </tr>
    <tr>
      <td>Control ID</td>
      <td>The benchmark identifier derived from a copied script filename, such as <code>1.1.1.1</code>.</td>
...
<div class="content-card assess-centos-7-220-cis-markdown-card assess-centos-7-220-cis-markdown-card-citations">

<h2 class="assess-centos-7-220-cis-section-heading"><i class="bi bi-journal-text" aria-hidden="true"></i><span>References</span></h2>

<p>These sources support the in-text citations used in this tool page.</p>

<table class="assess-centos-7-220-cis-citation-table">
  <thead>
    <tr>
      <th>Source type</th>
  ...
  <tbody>
    <tr id="assess-centos-7-220-cis-ref-primary">
      <td>Benchmark website</td>
      <td><a class="assess-centos-7-220-cis-citation-backlink" href="#assess-centos-7-220-cis-cite-primary"><span class="assess-centos-7-220-cis-citation-inline">(Center for Internet Security (n.d.-a))</span></a></td>
      <td>Center for Internet Security. (n.d.-a). <em>CIS Benchmarks</em>. Retrieved June 2, 2026, from <a href="https://learn.cisecurity.org/benchmarks">https://learn.cisecurity.org/benchmarks</a></td>
    </tr>
    <tr id="assess-centos-7-220-cis-ref-method">
      <td>Operating system lifecycle</td>
      <td><a class="assess-centos-7-220-cis-citation-backlink" href="#assess-centos-7-220-cis-cite-method"><span class="assess-centos-7-220-cis-citation-inline">(The CentOS Project (n.d.))</span></a></td>
      <td>The CentOS Project. (n.d.). <em>CentOS Linux</em>. Retrieved June 2, 2026, from <a href="https://www.centos.org/centos-linux/">https://www.centos.org/centos-linux/</a></td>
    </tr>
    <tr id="assess-centos-7-220-cis-ref-review">
      <td>Assessment tool documentation</td>
      <td><a class="assess-centos-7-220-cis-citation-backlink" href="#assess-centos-7-220-cis-cite-review"><span class="assess-centos-7-220-cis-citation-inline">(Center for Internet Security (n.d.-b))</span></a></td>
