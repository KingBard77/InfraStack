...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-overview">

## Overview

AWS Cost Calculator is an InfraStack workspace for building a first-pass monthly AWS run-rate estimate from visible workload assumptions. It focuses on the spend drivers this workspace can model directly: <span class="calculate-cost-aws-term-accent">EC2</span>, <span class="calculate-cost-aws-term-accent">EBS</span>, <span class="calculate-cost-aws-term-accent">S3</span>, <span class="calculate-cost-aws-term-accent">Lambda</span>, <span class="calculate-cost-aws-term-accent">API Gateway</span>, shared internet egress, support uplift, contingency, and manual monthly adjustments. <a id="calculate-cost-aws-cite-primary" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-primary"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-a)</span></a> provides AWS Pricing Calculator for building service estimates, so this workspace keeps its result framed as a planning estimate rather than a bill.

<a id="calculate-cost-aws-cite-method" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-method"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-b)</span></a> publishes EC2 pricing around purchase options such as On-Demand, Savings Plans, Spot Instances, and capacity reservations, which is why the EC2 inputs stay visible for review.

<a id="calculate-cost-aws-cite-review" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-review"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-c)</span></a> prices Lambda around request and compute usage, so serverless line items should be checked against expected invocation volume and runtime before sharing the estimate.

The calculator is useful when a team needs a planning number that can be inspected, challenged, copied, and exported. It is not an AWS bill, a pricing quote, a contract-aware calculator, or a replacement for AWS Pricing Calculator, Cost Explorer, billing data, or private rate-card review.

Use it when you need to:

- Build a quick monthly estimate before a deeper FinOps review
- Compare EC2 purchase-model assumptions against the same workload shape
...
<div class="calculate-cost-aws-markdown-table-wrap">
<table>
  <thead>
    <tr>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-technical">

<h2 class="calculate-cost-aws-section-heading"><i class="bi bi-calculator" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The estimate notes stay tied to official AWS pricing sources. <a id="calculate-cost-aws-cite-technical-primary" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-primary"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-a)</span></a> anchors the calculator framing, and <a id="calculate-cost-aws-cite-technical-method" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-method"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-b)</span></a> anchors the EC2 purchase-model assumptions that appear in the service drivers below. <a id="calculate-cost-aws-cite-technical-review" class="calculate-cost-aws-citation-link" href="#calculate-cost-aws-ref-review"><span class="calculate-cost-aws-citation-inline">Amazon Web Services (n.d.-c)</span></a> anchors the Lambda and serverless pricing review surface that should be reviewed before the estimate is shared.
...
<h3 class="calculate-cost-aws-technical-step-heading">1. Estimate model</h3>
...
<h3 class="calculate-cost-aws-technical-step-heading">2. Starter catalog and overrides</h3>

The workspace includes a compact starter catalog for common AWS pricing inputs. These rates are intentionally visible in Advanced controls so they can be replaced when your region, enterprise agreement, discount model, or workload shape differs.

<h3 class="calculate-cost-aws-technical-step-heading">3. Service drivers</h3>
...
<table>
  ...
  <tbody>
    <tr>
      <td>EC2</td>
      <td>Instance type, instance count, monthly hours, purchase model, and optional custom hourly rate.</td>
      <td>Is the instance family and purchase model realistic for this workload?</td>
    </tr>
    <tr>
      <td>EBS</td>
      <td>gp3 storage, additional IOPS, additional throughput, and rate overrides.</td>
      <td>Is storage sized from real data growth or just a comfortable round number?</td>
    </tr>
    <tr>
      <td>S3</td>
      <td>Storage, GET requests, PUT/LIST requests, and S3-origin egress.</td>
    ...
    <tr>
      <td>API Gateway</td>
      <td>HTTP or REST API type, monthly requests, response size, egress contribution, and API free-tier toggle.</td>
      <td>Does REST API pricing materially change the estimate compared with HTTP API?</td>
    </tr>
    <tr>
      <td>Shared egress</td>
...
<h3 class="calculate-cost-aws-technical-step-heading">4. Formula boundaries</h3>

The output is arithmetic from visible assumptions. It does not discover real accounts, read billing history, validate live AWS regional prices, include every AWS service, calculate taxes, apply private pricing, or prove budget readiness.
...
<h3 class="calculate-cost-aws-technical-step-heading">5. Review boundaries</h3>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Verify expensive rates in AWS pricing pages, Cost Explorer, billing exports, or contract data.</td>
    </tr>
    <tr>
      <td>Free tier</td>
...
<h3 class="calculate-cost-aws-technical-step-heading">6. How to read the estimate</h3>
...
For AWS, the first review pass should separate workload shape from commercial reality. Workload shape covers instance count, monthly hours, storage size, request volume, response size, and expected egress. Commercial reality covers purchase model, negotiated pricing, credits, reserved capacity, Savings Plans, support charges, and account-specific billing behavior. The workspace can expose fields for those ideas, but it does not know your contract, organization policy, or live usage history.

<h3 class="calculate-cost-aws-technical-step-heading">7. Scenario discipline</h3>
...
The service mix chart is a triage surface. It tells you where to spend review time first. If EC2 dominates, inspect instance family, purchase model, and utilization hours. If storage dominates, inspect growth, IOPS, throughput, request counts, and retention assumptions. If egress dominates, challenge response size, CDN use, public transfer paths, and whether data movement belongs to the application, backup process, analytics flow, or integration path.

<h3 class="calculate-cost-aws-technical-step-heading">8. Assumption hygiene</h3>
...
<h3 class="calculate-cost-aws-technical-step-heading">9. Export and handoff behavior</h3>
...
The estimate does not read Cost Explorer, billing exports, AWS Pricing Calculator sessions, live regional price APIs, or deployment telemetry. It also does not calculate taxes, support plans, marketplace charges, savings-plan utilization, or enterprise discounts unless you express those effects through visible overrides or adjustments. That boundary is a feature, not a defect: it keeps the page fast, transparent, and honest about what it knows.

<h3 class="calculate-cost-aws-technical-step-heading">10. Practical review checklist</h3>

Before sharing an AWS estimate, confirm that the scenario label, preset, included services, monthly hours, data sizes, request counts, and egress assumptions describe the same workload. Mixed scopes are the fastest way to produce a confident-looking number that nobody can actually defend.
...
Then review the largest line items in order. For EC2, check whether the instance type, count, purchase model, and running hours match the expected operating pattern. A workload that sleeps overnight should not look like a continuous production fleet unless that is deliberate. For EBS, check capacity and performance separately; storage size, IOPS, and throughput can tell different stories. For S3, look beyond stored gigabytes and inspect request volume plus outbound transfer. For Lambda and API Gateway, make sure request count, duration, memory, API type, and response size are tied to real traffic assumptions rather than a nice round guess.
...
When reviewers can trace a total back to explicit assumptions, the estimate becomes useful even before it is perfect, because the team knows which inputs to measure, which prices to verify, and which decisions still need ownership now.

</div>
<!-- ns:end main.content.02_technical-details -->

<!-- ns:start main.content.03_example-prompts -->
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-examples">
...
<pre class="calculate-cost-aws-prompt-pre"><code>Estimate a lean AWS web platform from the Lean web platform preset. Include 2 t4g.medium EC2 instances running 730 hours on On-Demand, 120 GB gp3 EBS at baseline IOPS and throughput, 250 GB S3 storage, 80 GB S3-origin egress, 2 million HTTP API requests with 32 KB average response size, 120 GB shared internet egress, 5% support uplift, and 10% contingency.</code></pre>

<details class="calculate-cost-aws-prompt-note" open>
  <summary>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-closed">Show prompt use</span>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-open">Hide prompt use</span>
    <button type="button" class="calculate-cost-aws-prompt-copy-btn" data-prompt-copy-index="0">
...
<pre class="calculate-cost-aws-prompt-pre"><code>Estimate a serverless AWS API from the Serverless API preset. Disable EC2 and EBS unless a companion instance is in scope. Include 80 GB S3 storage, 40 GB S3 egress, 12 million Lambda requests at 180 ms average duration and 512 MB memory, 12 million HTTP API requests with 24 KB average response size, 120 GB shared egress, applicable free-tier toggles, 8% support uplift, and 12% contingency.</code></pre>

<details class="calculate-cost-aws-prompt-note">
  <summary>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-closed">Show prompt use</span>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-open">Hide prompt use</span>
    <button type="button" class="calculate-cost-aws-prompt-copy-btn" data-prompt-copy-index="1">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy prompt</span>
    </button>
  </summary>
...
<pre class="calculate-cost-aws-prompt-pre"><code>Estimate a steady AWS application platform from the Steady application platform preset. Include 6 m7g.large EC2 instances running 730 hours with Savings Plan comparison, 900 GB gp3 EBS with 6000 IOPS and 250 MB/s throughput, 2 TB S3 storage, 600 GB S3 egress, 8 million REST API requests with 48 KB average response size, 600 GB shared egress, 10% support uplift, and 15% contingency.</code></pre>

<details class="calculate-cost-aws-prompt-note">
  <summary>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-closed">Show prompt use</span>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-open">Hide prompt use</span>
    <button type="button" class="calculate-cost-aws-prompt-copy-btn" data-prompt-copy-index="2">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy prompt</span>
    </button>
  </summary>
  <div class="alert alert-warning d-flex align-items-start gap-3 mb-0" role="alert">
    ...
    <div><strong>Commitment review:</strong> Useful when a stable workload may justify comparing On-Demand, Savings Plan, and reserved coverage assumptions.</div>
  </div>
</details>

<pre class="calculate-cost-aws-prompt-pre"><code>Estimate a mixed AWS workload from the Blank estimate preset. Include a custom EC2 worker profile with 4 vCPU, 16 GiB memory, 4 instances, 500 monthly hours, On-Demand pricing, 600 GB gp3 EBS with 5000 IOPS and 200 MB/s throughput, 1200 GB S3 storage, 350 GB S3 egress, 3 million Lambda requests at 250 ms and 1024 MB memory, 4 million HTTP API requests with 40 KB response size, 300 GB shared egress, a named manual adjustment for known NAT, load balancer, observability, or backup costs, 10% support uplift, and 10% contingency.</code></pre>

<details class="calculate-cost-aws-prompt-note calculate-cost-aws-prompt-note-last">
  <summary>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-closed">Show prompt use</span>
    <span class="calculate-cost-aws-prompt-note-label calculate-cost-aws-prompt-note-label-open">Hide prompt use</span>
    <button type="button" class="calculate-cost-aws-prompt-copy-btn" data-prompt-copy-index="3">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy prompt</span>
    </button>
  </summary>
  <div class="alert alert-info d-flex align-items-start gap-3 mb-0" role="alert">
    ...
    <div><strong>Scope-gap review:</strong> Useful when the calculator covers most of the workload, but a few known AWS services must be added as explicit manual adjustments.</div>
  </div>
</details>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-prompt-tips calculate-cost-aws-markdown-card-input-tips">
...
<li>Network egress, S3 requests, or Lambda duration are large enough to dominate the result.</li>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-how-to">
  <h2 class="calculate-cost-aws-section-heading"><i class="bi bi-list-check calculate-cost-aws-section-heading-icon" aria-hidden="true"></i><span>How To Use</span></h2>
  ...
  <details class="tool-guidance-item" open>
    ...
    <div class="tool-guidance-answer">
      <p>Choose the closest AWS Cost Calculator preset, then name the estimate or scenario so exported results can be traced back to the workload being reviewed.</p>
    </div>
  </details>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-export">
  <h2 class="calculate-cost-aws-section-heading"><i class="bi bi-download calculate-cost-aws-section-heading-icon" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-citations">

## References

These sources support the in-text citations used in this tool page.

<table class="calculate-cost-aws-citation-table">
  <thead>
    <tr>
      <th>Source type</th>
  ...
  <tbody>
    <tr id="calculate-cost-aws-ref-primary">
      <td>Pricing website</td>
      <td><a class="calculate-cost-aws-citation-backlink" href="#calculate-cost-aws-cite-primary"><span class="calculate-cost-aws-citation-inline">(Amazon Web Services, n.d.-a)</span></a></td>
      <td>Amazon Web Services. (n.d.-a). <em>AWS Pricing Calculator</em>. Retrieved May 13, 2026, from <a href="https://calculator.aws/">https://calculator.aws/</a></td>
    </tr>
    <tr id="calculate-cost-aws-ref-method">
      <td>Pricing page</td>
      <td><a class="calculate-cost-aws-citation-backlink" href="#calculate-cost-aws-cite-method"><span class="calculate-cost-aws-citation-inline">(Amazon Web Services, n.d.-b)</span></a></td>
      <td>Amazon Web Services. (n.d.-b). <em>Amazon EC2 pricing</em>. Retrieved May 13, 2026, from <a href="https://aws.amazon.com/ec2/pricing/">https://aws.amazon.com/ec2/pricing/</a></td>
    </tr>
    <tr id="calculate-cost-aws-ref-review">
      <td>Pricing page</td>
      <td><a class="calculate-cost-aws-citation-backlink" href="#calculate-cost-aws-cite-review"><span class="calculate-cost-aws-citation-inline">(Amazon Web Services, n.d.-c)</span></a></td>
      <td>Amazon Web Services. (n.d.-c). <em>AWS Lambda pricing</em>. Retrieved May 13, 2026, from <a href="https://aws.amazon.com/lambda/pricing/">https://aws.amazon.com/lambda/pricing/</a></td>
    </tr>
  </tbody>
</table>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-faq">

## FAQ

<details class="faq-item" open>
  <summary>Is this an official AWS pricing calculator?</summary>
...
<details class="faq-item">
  <summary>Does it use live AWS pricing?</summary>
  <div class="faq-answer">
    No. It uses browser-side starter rates and any overrides you enter. Verify material numbers in official AWS pricing, Cost Explorer, billing exports, or contract data.
  </div>
</details>
...
<details class="faq-item">
  ...
  <div class="faq-answer">
    The current calculator models EC2, EBS, S3, Lambda, API Gateway, shared internet egress, support uplift, contingency, and manual monthly adjustments.
  </div>
</details>
...
<div class="content-card calculate-cost-aws-markdown-card calculate-cost-aws-markdown-card-acronyms">
