...
The workspace includes a compact starter catalog for common AWS pricing inputs. These rates are intentionally visible in Custom controls so they can be replaced when your region, enterprise agreement, discount model, or workload shape differs.
