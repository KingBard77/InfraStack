...
{{ include('content/tools/aws/aws-vpc-architecture/assets/bin/model-core.js')|raw }}

const awsVpcPresetCatalog = [
    {
        id: 'three-tier-web',
        label: '3-Tier Web',
...
const AWS_VPC_TOOL_ID = AwsVpcModelCore.toolId;
const AWS_VPC_TOOL_VERSION = AwsVpcModelCore.toolVersion;
const awsVpcRegionCatalog = AwsVpcModelCore.regionCatalog;
const awsVpcSupportedRegions = AwsVpcModelCore.supportedRegions;
const awsVpcAllowedNatModes = AwsVpcModelCore.allowedNatModes;
const awsVpcAllowedAppTiers = AwsVpcModelCore.allowedAppTiers;
const awsVpcAllowedDatabases = AwsVpcModelCore.allowedDatabases;

const awsVpcIconSvgMap = {
    amazonVpc: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-Virtual-Private-Cloud_48.svg')|json_encode|raw }},
    route53: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-Route-53_48.svg')|json_encode|raw }},
    cloudFront: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-CloudFront_48.svg')|json_encode|raw }},
    waf: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-WAF_48.svg')|json_encode|raw }},
    internetGateway: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Amazon-VPC_Internet-Gateway_48_Light.svg')|json_encode|raw }},
    applicationLoadBalancer: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Elastic-Load-Balancing_Application-Load-Balancer_48_Light.svg')|json_encode|raw }},
    vpcRouter: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Amazon-VPC_Router_48_Light.svg')|json_encode|raw }},
    natGateway: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Amazon-VPC_NAT-Gateway_48_Light.svg')|json_encode|raw }},
    ec2: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-EC2_48.svg')|json_encode|raw }},
    ec2AutoScaling: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-EC2-Auto-Scaling_48.svg')|json_encode|raw }},
    ecs: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-Elastic-Container-Service_48.svg')|json_encode|raw }},
    eks: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-Elastic-Kubernetes-Service_48.svg')|json_encode|raw }},
    fargate: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-Fargate_48.svg')|json_encode|raw }},
    lambda: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-Lambda_48.svg')|json_encode|raw }},
    rds: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-RDS_48.svg')|json_encode|raw }},
    aurora: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-Aurora_48.svg')|json_encode|raw }},
    dynamodb: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-DynamoDB_48.svg')|json_encode|raw }},
    elasticache: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-ElastiCache_48.svg')|json_encode|raw }},
    vpcEndpoints: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Amazon-VPC_Endpoints_48_Light.svg')|json_encode|raw }},
    vpcFlowLogs: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Res_Amazon-VPC_Flow-Logs_48_Light.svg')|json_encode|raw }},
    cloudWatch: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_Amazon-CloudWatch_48.svg')|json_encode|raw }},
    systemsManager: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-Systems-Manager_48.svg')|json_encode|raw }},
    siteToSiteVpn: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-Site-to-Site-VPN_48.svg')|json_encode|raw }},
    transitGateway: {{ include('content/tools/aws/aws-vpc-architecture/assets/icon/Arch_AWS-Transit-Gateway_48.svg')|json_encode|raw }}
};

document.addEventListener('DOMContentLoaded', function () {
    const promptInput = document.getElementById('awsVpcPrompt');
    const generateButton = document.getElementById('awsVpcGenerate');
    const resetButton = document.getElementById('awsVpcReset');
    const errorState = document.getElementById('awsVpcErrorState');
    const presetInput = document.getElementById('awsVpcPreset');
    const presetDescription = document.getElementById('awsVpcPresetDescription');
    const stageTitle = document.getElementById('awsVpcStageTitle');
    const stageSubtitle = document.getElementById('awsVpcStageSubtitle');
    const stageMeta = document.getElementById('awsVpcStageMeta');
    const stageEmpty = document.getElementById('awsVpcStageEmpty');
    const stageCanvas = document.getElementById('awsVpcStageCanvas');
    const stageShell = document.getElementById('awsVpcStageShell');
    const zoomControl = document.getElementById('awsVpcZoomControl');
    const zoomLabel = document.getElementById('awsVpcZoomLabel');
    const zoomInput = document.getElementById('awsVpcZoomInput');
    const zoomOutButton = document.getElementById('awsVpcZoomOut');
    const zoomInButton = document.getElementById('awsVpcZoomIn');
    const zoomFitButton = document.getElementById('awsVpcZoomFit');
    const zoomActualButton = document.getElementById('awsVpcZoomActual');
    const zoomHideUiButton = document.getElementById('awsVpcZoomHideUi');
    const fullscreenButton = document.getElementById('awsVpcFullscreen');
    const resetLayoutButton = document.getElementById('awsVpcResetLayout');
    const outputEmpty = document.getElementById('awsVpcOutputEmpty');
    const outputContent = document.getElementById('awsVpcOutputContent');
    const outputStatus = document.getElementById('awsVpcOutputStatus');
    const inventoryTableBody = document.getElementById('awsVpcInventoryTableBody');
    const inventorySortInput = document.getElementById('awsVpcInventorySort');
    const inventorySortSelect = document.getElementById('awsVpcInventorySortSelect');
    const inventorySortSummary = document.getElementById('awsVpcInventorySortSummary');
    const inventorySortOptions = Array.from(document.querySelectorAll('.aws-vpc-sort-option'));
    const jsonOutput = document.getElementById('awsVpcJsonOutput');
    const promptSummary = document.getElementById('awsVpcPromptSummary');
    const keywordList = document.getElementById('awsVpcKeywordList');
    const assumptionList = document.getElementById('awsVpcAssumptionList');
    const modelList = document.getElementById('awsVpcModelList');
    const prosList = document.getElementById('awsVpcProsList');
    const consList = document.getElementById('awsVpcConsList');
    const selectedEmpty = document.getElementById('awsVpcSelectedEmpty');
    const selectedEditor = document.getElementById('awsVpcSelectedEditor');
    const selectedName = document.getElementById('awsVpcSelectedName');
    const selectedXInput = document.getElementById('awsVpcSelectedX');
    const selectedYInput = document.getElementById('awsVpcSelectedY');
    const selectedWidthInput = document.getElementById('awsVpcSelectedWidth');
    const selectedHeightInput = document.getElementById('awsVpcSelectedHeight');
    const applyCardSizeButton = document.getElementById('awsVpcApplyCardSize');
    const resetCardSizeButton = document.getElementById('awsVpcResetCardSize');
    const exportPngButton = document.getElementById('awsVpcExportPng');
    const downloadSvgButton = document.getElementById('awsVpcDownloadSvg');
    const copyJsonButton = document.getElementById('awsVpcCopyJson');
    const downloadJsonButton = document.getElementById('awsVpcDownloadJson');
    const importJsonButton = document.getElementById('awsVpcImportJsonButton');
    const importJsonInput = document.getElementById('awsVpcImportJson');
    const tabButtons = Array.from(document.querySelectorAll('.aws-vpc-tab-btn'));
    const tabPanels = Array.from(document.querySelectorAll('.aws-vpc-tab-panel'));
    const configTabButtons = Array.from(document.querySelectorAll('.aws-vpc-config-tab'));
    const configTabPanels = Array.from(document.querySelectorAll('[data-config-panel]'));
    const regionInput = document.getElementById('awsVpcRegion');
    const cidrInput = document.getElementById('awsVpcCidr');
    const azCountInput = document.getElementById('awsVpcAzCount');
    const natModeInput = document.getElementById('awsVpcNatMode');
    const appTierInput = document.getElementById('awsVpcAppTier');
    const databaseInput = document.getElementById('awsVpcDatabase');
    const route53Input = document.getElementById('awsVpcRoute53');
    const cloudFrontInput = document.getElementById('awsVpcCloudFront');
    const wafInput = document.getElementById('awsVpcWaf');
    const albInput = document.getElementById('awsVpcAlb');
    const bastionInput = document.getElementById('awsVpcBastion');
    const endpointsInput = document.getElementById('awsVpcEndpoints');
    const flowLogsInput = document.getElementById('awsVpcFlowLogs');
    const cloudWatchInput = document.getElementById('awsVpcCloudWatch');
    const siteToSiteVpnInput = document.getElementById('awsVpcSiteToSiteVpn');
    const transitGatewayInput = document.getElementById('awsVpcTransitGateway');
    const cacheInput = document.getElementById('awsVpcCache');
    ...
    let selectedPresetId = awsVpcPresetCatalog[0].id;
    ...
    function initMarkdownCopyButtons() {
        const promptBlocks = Array.from(document.querySelectorAll('.markdown-content pre.aws-vpc-prompt-pre'));
        const promptCopyButtons = document.querySelectorAll('.aws-vpc-prompt-copy-btn');
        ...
        const codeBlocks = document.querySelectorAll('.markdown-content pre:not(.aws-vpc-prompt-pre)');
    ...
    function normalizePrompt(value) {
        return AwsVpcModelCore.normalizePrompt(value);
    }

    function normalizeCidrInput(value) {
        return AwsVpcModelCore.normalizeCidrInput(value);
    }
    ...
    function isValidIpv4Cidr(value) {
        return AwsVpcModelCore.isValidIpv4Cidr(value);
    }

    function parseCidrValue(value) {
        return AwsVpcModelCore.parseCidrValue(value);
    }
    ...
    function isSupportedImportVersion(version) {
        ...
        return version.split('.')[0] === AWS_VPC_TOOL_VERSION.split('.')[0];
    }
    ...
    function buildImportedPayloadState(payload) {
        return AwsVpcModelCore.buildImportedPayloadState(payload, awsVpcPresetCatalog);
    }

    function natModeLabel(value) {
        return AwsVpcModelCore.natModeLabel(value);
    }

    function appTierLabel(value) {
        return AwsVpcModelCore.appTierLabel(value);
    }

    function databaseLabel(value) {
        return AwsVpcModelCore.databaseLabel(value);
    }
    ...
    function initializeCustomSelect(selectElement) {
        ...
        wrapper.className = 'aws-vpc-custom-select';
        button.type = 'button';
        button.className = 'aws-vpc-custom-select-trigger';
        button.setAttribute('aria-haspopup', 'listbox');
        button.setAttribute('aria-expanded', 'false');
        valueElement.className = 'aws-vpc-custom-select-value';
        icon.className = 'bi bi-chevron-down';
        icon.setAttribute('aria-hidden', 'true');
        menu.className = 'aws-vpc-custom-select-menu';
        ...
        selectElement.classList.add('aws-vpc-native-select');
        ...
        Array.from(selectElement.options).forEach(function (option) {
            ...
            optionButton.className = 'aws-vpc-custom-select-option';
    ...
    function findPresetById(presetId) {
        return awsVpcPresetCatalog.find(function (preset) {
            return preset.id === presetId;
        }) || awsVpcPresetCatalog[0];
    }

    function populateRegionOptions() {
        const currentValue = regionInput.value;

        regionInput.innerHTML = awsVpcRegionCatalog.map(function (region) {
            return '<option value="' + escapeHtml(region.value) + '">' + escapeHtml(region.label) + '</option>';
        }).join('');

        regionInput.value = awsVpcSupportedRegions.includes(currentValue)
            ? currentValue
            : awsVpcRegionCatalog[0].value;
    }
    ...
    function setStageUiHidden(isHidden) {
        ...
        stageShell.classList.toggle('aws-vpc-stage-ui-hidden', stageUiHidden);
    ...
    function updateFullscreenButton() {
        const isFullscreen = document.fullscreenElement === stageShell || stageShell.classList.contains('aws-vpc-stage-expanded');
    ...
    function setStageExpanded(isExpanded) {
        stageShell.classList.toggle('aws-vpc-stage-expanded', Boolean(isExpanded));
        document.body.classList.toggle('aws-vpc-stage-expanded-lock', Boolean(isExpanded));
    ...
    async function toggleFullscreen() {
        try {
            if (stageShell.classList.contains('aws-vpc-stage-expanded')) {
    ...
    function createToneChip(iconClass, label, tone) {
        return [
            '<span class="aws-vpc-score-tag aws-vpc-score-tag-' + escapeHtml(tone) + '">',
    ...
    function extractRegion(prompt, fallbackRegion, assumptions, matchedKeywords) {
        ...
        const matched = awsVpcSupportedRegions.find(function (region) {
    ...
    function buildPromptTitle(prompt, fallbackLabel) {
        return AwsVpcModelCore.buildPromptTitle(prompt, fallbackLabel);
    }

    function inferFromPrompt(prompt, preset) {
        return AwsVpcModelCore.inferFromPrompt(prompt, preset);
    }
    ...
    function describeInventoryItem(item, spec) {
        ...
        if (component === 'amazon vpc') {
            return 'Isolated regional network boundary where the subnets, route tables, gateways, endpoints, and security controls attach to the CIDR range.';
        }

        if (component === 'route 53') {
            return 'DNS entry point for the application hostname, resolving users toward CloudFront when present or directly toward the load balancer.';
        }

        if (component === 'cloudfront') {
            return 'Global edge distribution layer that receives viewer traffic, can cache static content, and forwards dynamic requests to the origin path.';
        }
        ...
        if (component === 'ec2 auto scaling') {
            return 'Private compute fleet that scales EC2 instances across app subnets, usually registered behind the load balancer target group.';
        }

        if (component === 'ecs / fargate') {
            return 'Managed container service running tasks in private subnets with elastic network interfaces and service routing through the ingress tier.';
        }

        if (component === 'eks') {
            return 'Kubernetes workload tier with private worker capacity, keeping cluster workloads off direct public subnet placement.';
        }
        ...
        if (component === 'dynamodb') {
            return 'Regional serverless data tier outside the VPC boundary, normally reached privately through a gateway endpoint when endpoints are enabled.';
        }
        ...
        if (component === 'vpc endpoints') {
            return 'Private AWS service access path, covering gateway endpoint patterns such as S3 and interface endpoint patterns such as Systems Manager.';
        }
        ...
        if (component === 'site-to-site vpn') {
            return 'IPsec hybrid connectivity path between on-premises networks and the VPC routing domain.';
        }
        ...
        if (component === 'vpc flow logs') {
            return 'Network telemetry capture for accepted and rejected traffic at VPC, subnet, or network-interface scope.';
        }
    ...
    function buildArchitectureProsCons(spec) {
        ...
        if (spec.cloudWatch && spec.flowLogs) {
            ...
            cons.push('Observability is partial; pair CloudWatch metrics with flow logs for better operations coverage.');
        } else {
    ...
    function resolveCardIconHref(card) {
        if (!card.iconKey || !Object.prototype.hasOwnProperty.call(awsVpcIconSvgMap, card.iconKey)) {
            return '';
        }

        return buildSvgDataUri(awsVpcIconSvgMap[card.iconKey]);
    }
    ...
    function cloneLayoutOverrides(layoutOverrides) {
        return AwsVpcModelCore.cloneLayoutOverrides(layoutOverrides);
    }

    function cloneConnectorOverrides(connectorOverrides) {
        return AwsVpcModelCore.cloneConnectorOverrides(connectorOverrides);
    }
    ...
    function renderCardConnector(sourceCard, targetCard, options) {
        ...
        const markerId = resolvedOptions.active ? 'awsVpcArrowActive' : 'awsVpcArrow';
    ...
    function renderVpcShell(shell) {
        ...
        return [
            ...
            iconImage,
            buildMultilineText(shell.x + 60, shell.y + 34, ['Amazon VPC'], 'diagram-vpc-title', 16),
    ...
    function buildSvgMarkup(spec, layoutOverrides, connectorOverrides) {
        ...
        if (albCard) {
            appCards.forEach(function (card) {
                connectors.push(renderCardConnector(albCard, card, {
                    id: 'application-load-balancer-to-' + card.id,
                    sourceSide: 'bottom',
                    targetSide: 'top',
                    active: true
                }));
            ...
            appCards.forEach(function (card) {
                connectors.push(renderCardConnector(igwCard, card, {
                    id: 'internet-gateway-to-' + card.id,
                    sourceSide: 'bottom',
                    targetSide: 'top',
                    active: true
                }));
        ...
        if (spec.endpoints) {
            addRightRailCard({
                ...
                label: 'VPC Endpoints',
                short: 'EP',
                subtitle: ['Private S3 and SSM access'],
                tone: 'service',
        ...
        return {
            svgMarkup: [
                ...
                '.diagram-vpc{fill:#fff7ed;stroke:#f0c98c;stroke-width:2;}',
                '.diagram-card-group.is-selected .diagram-vpc{stroke:#7c3aed;stroke-width:3;filter:drop-shadow(0 10px 18px rgba(124,58,237,0.18));}',
                '.diagram-vpc-title{fill:#7c2d12;font-size:var(--diagram-font-title);font-weight:800;}',
                '.diagram-vpc-meta{fill:#9a3412;font-size:var(--diagram-font-meta);font-weight:600;}',
                '.diagram-card{stroke:#d8b483;stroke-width:1.5;filter:drop-shadow(0 6px 10px rgba(120,72,24,0.08));}',
                '.diagram-card-zone{fill:#fffdf8;}',
                '.diagram-card-public{fill:#fff1dc;}',
                '.diagram-card-private{fill:#fffaf2;}',
                '.diagram-card-service{fill:#ffffff;}',
                '.diagram-card-edge{fill:#fff7ed;}',
                '.diagram-card-security{fill:#f5f3ff;stroke:#c4b5fd;}',
                '.diagram-card-database{fill:#fef3c7;stroke:#fbbf24;}',
                '.diagram-card-hitbox{fill:transparent;pointer-events:all;}',
                '.diagram-card-group.is-selected .diagram-card{stroke:#7c3aed;stroke-width:3;filter:drop-shadow(0 10px 18px rgba(124,58,237,0.18));}',
                '.diagram-resize-handle{display:none;fill:#ffffff;stroke:#7c3aed;stroke-width:2;cursor:nwse-resize;pointer-events:all;filter:drop-shadow(0 4px 8px rgba(124,58,237,0.24));}',
                ...
                '.diagram-resize-preview{fill:rgba(124,58,237,0.08);stroke:#7c3aed;stroke-width:2;stroke-dasharray:8 6;pointer-events:none;}',
                '.diagram-pill{stroke:none;}',
                '.diagram-pill-zone{fill:#f3f4f6;}',
                '.diagram-pill-public{fill:#fed7aa;}',
                '.diagram-pill-private{fill:#fde68a;}',
                '.diagram-pill-service{fill:#ddd6fe;}',
                '.diagram-pill-edge{fill:#fdba74;}',
                '.diagram-pill-security{fill:#c4b5fd;}',
                '.diagram-pill-database{fill:#f59e0b;}',
                ...
                '.diagram-zone-label{fill:#7c2d12;font-size:var(--diagram-font-zone-label);font-weight:800;}',
                '.diagram-connector{fill:none;stroke:#7c3aed;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round;opacity:0.92;pointer-events:stroke;}',
                '.diagram-connector-active{stroke:#f97316;stroke-width:2.8;}',
                '.diagram-connector.is-selected{stroke:#0ea5e9;stroke-width:4;opacity:1;}',
                '.diagram-connector-anchor-handle{fill:#ffffff;stroke:#0ea5e9;stroke-width:3;cursor:grab;pointer-events:all;filter:drop-shadow(0 4px 8px rgba(14,165,233,0.24));}',
                '.diagram-connector-anchor-handle:active{cursor:grabbing;}',
                '.diagram-connector-bend-handle{fill:#0ea5e9;stroke:#ffffff;stroke-width:3;cursor:move;pointer-events:all;filter:drop-shadow(0 4px 8px rgba(14,165,233,0.28));}',
                ...
                '.diagram-card-group-draggable:hover .diagram-card{stroke:#7c3aed;stroke-width:2.2;}',
                '.diagram-card-group-draggable:focus-visible{outline:none;}',
                '.diagram-card-group-draggable:focus-visible .diagram-card{stroke:#7c3aed;stroke-width:2.6;filter:drop-shadow(0 10px 18px rgba(124,58,237,0.18));}',
                '.diagram-card-group-draggable:focus-visible .diagram-vpc{stroke:#7c3aed;stroke-width:2.8;filter:drop-shadow(0 10px 18px rgba(124,58,237,0.18));}',
                ']]></style>',
                '<marker id="awsVpcArrow" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto" markerUnits="strokeWidth">',
                '<path d="M 0 0 L 10 5 L 0 10 z" fill="#7c3aed"></path>',
                '</marker>',
                '<marker id="awsVpcArrowActive" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto" markerUnits="strokeWidth">',
    ...
    function buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides) {
        return AwsVpcModelCore.buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides, buildNotePayload(spec));
    }
    ...
    function renderInventory(inventory) {
        ...
        inventoryTableBody.innerHTML = sortedInventory.map(function (item, index) {
            return [
                ...
                '<td class="aws-vpc-table-action-cell">',
                '<button type="button" class="aws-vpc-row-copy" data-inventory-copy-row="' + escapeHtml(index) + '" aria-label="Copy inventory row ' + escapeHtml(item.inventoryIndex || index + 1) + '" title="Copy inventory row">',
    ...
    function renderOutputScore(spec) {
        ...
        outputStatus.innerHTML = [
            '<div class="aws-vpc-score-ring-card">',
            '<div class="aws-vpc-score-value" data-score-angle="' + escapeHtml(String(scorePayload.angle)) + 'deg" aria-label="Architecture score ' + escapeHtml(String(scorePayload.score)) + ' out of 100">',
            '<span class="aws-vpc-score-value-number">' + escapeHtml(String(scorePayload.score)) + '</span>',
            '<span class="aws-vpc-score-value-scale">/100</span>',
            '</div>',
            '<div class="aws-vpc-score-ring-label">' + escapeHtml(scorePayload.ringLabel) + '</div>',
            '</div>',
            '<div class="aws-vpc-score-copy">',
            '<div class="aws-vpc-score-kicker">Architecture Score</div>',
            '<div class="aws-vpc-score-summary">' + escapeHtml(scorePayload.band) + '</div>',
            '<div class="aws-vpc-score-detail">' + escapeHtml(scorePayload.detail) + '</div>',
            '<div class="aws-vpc-score-tags">',
            [
                '<span class="aws-vpc-score-tag aws-vpc-score-tag-status aws-vpc-score-tag-status-' + escapeHtml(scorePayload.badgeTone) + '">',
            ...
            scorePayload.tags.map(function (item) {
                return [
                    '<span class="aws-vpc-score-tag aws-vpc-score-tag-' + escapeHtml(item.tone) + '">',
        ...
        const scoreValue = outputStatus.querySelector('.aws-vpc-score-value');

        if (scoreValue) {
            scoreValue.style.setProperty('--aws-vpc-score-fill-angle', '0deg');

            window.requestAnimationFrame(function () {
                window.requestAnimationFrame(function () {
                    scoreValue.style.setProperty('--aws-vpc-score-fill-angle', String(scoreValue.dataset.scoreAngle || '0deg'));
                });
            });
        }
    }
    ...
    function resetToDefault() {
        applyPreset(awsVpcPresetCatalog[0].id, true);
    }
    ...
    function downloadSvg() {
        ...
        downloadFile('aws-vpc-architecture.svg', latestResult.svgMarkup, 'image/svg+xml;charset=utf-8');
    }
            ...
            image.onload = function () {
                ...
                if (context) {
                    ...
                    canvas.toBlob(function (blob) {
                        ...
                        downloadFile('aws-vpc-architecture.png', blob, 'image/png');
    ...
    function downloadJson() {
        ...
        downloadFile('aws-vpc-architecture.json', JSON.stringify(latestResult.exportPayload, null, 2), 'application/json;charset=utf-8');
    }
    ...
    presetInput.addEventListener('change', function () {
        applyPreset(String(presetInput.value || awsVpcPresetCatalog[0].id), true);
    });

    tabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateTab(String(button.dataset.tabTarget || 'awsVpcInventoryPanel'));
        });
    });
    ...
    configTabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateConfigTab(String(button.dataset.configTabTarget || 'awsVpcNetworkConfigPanel'));
        });
    });
    ...
    document.addEventListener('keydown', function (event) {
        if (event.key === 'Escape' && stageShell.classList.contains('aws-vpc-stage-expanded')) {
            setStageExpanded(false);
        }
    });
    ...
    inventoryTableBody.addEventListener('click', function (event) {
        const button = event.target.closest('.aws-vpc-row-copy');
    ...
    document.addEventListener('click', function (event) {
        if (event.target.closest('.aws-vpc-custom-select')) {
            return;
        }
    ...
    activateTab('awsVpcInventoryPanel');
    activateConfigTab('awsVpcNetworkConfigPanel');
    updateFullscreenButton();
    applyStageZoom();
    updatePresetSelection();
    applyPreset(awsVpcPresetCatalog[0].id, true);
