...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-overview">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-compass" aria-hidden="true"></i><span>Overview</span></h2>

  <p>Chmod Command Generator turns file-permission intent into a reviewed <code>chmod</code> command. It keeps octal mode, symbolic mode, owner/group/other bits, special bits, recursion, reference mode, target path, and shell quoting visible before the command is copied.</p>

  <p><a id="generate-chmod-shell-cite-review" class="generate-chmod-shell-citation-link" href="#generate-chmod-shell-ref-review"><span class="generate-chmod-shell-citation-inline">GNU Project (n.d.-b)</span></a> describes file mode bits as the access model behind symbolic and octal permission forms, so this workspace shows both the compact command and a readable permission breakdown.</p>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-technical">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-diagram-3" aria-hidden="true"></i><span>Technical Details</span></h2>

  <p>The generated command model follows the documented permission model rather than treating <code>chmod</code> as a memorized list of numbers. <a id="generate-chmod-shell-cite-primary" class="generate-chmod-shell-citation-link" href="#generate-chmod-shell-ref-primary"><span class="generate-chmod-shell-citation-inline">GNU Project (n.d.-a)</span></a> documents <code>chmod</code> as changing named file permissions by explicit mode or by reference file. <a id="generate-chmod-shell-cite-method" class="generate-chmod-shell-citation-link" href="#generate-chmod-shell-ref-method"><span class="generate-chmod-shell-citation-inline">Linux man-pages project (2025)</span></a> describes the underlying mode as permission bits plus set-user-ID, set-group-ID, and sticky bits. <a id="generate-chmod-shell-cite-technical-review" class="generate-chmod-shell-citation-link" href="#generate-chmod-shell-ref-review"><span class="generate-chmod-shell-citation-inline">GNU Project (n.d.-b)</span></a> explains that those mode bits can be represented symbolically or as octal numbers, which is why this workspace keeps both forms visible.</p>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">1. Permission Model As Review Data</h3>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">2. Octal And Symbolic Mode Selection</h3>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">3. Scope, Directories, And Recursive Change</h3>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">4. Special Bits And Reference Mode</h3>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">5. Shell Quoting, Paths, And Execution Context</h3>
  ...
  <h3 class="generate-chmod-shell-technical-step-heading">6. Exports And Operational Boundary</h3>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-command-tips">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-lightbulb" aria-hidden="true"></i><span>Command Tips</span></h2>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-how-to">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-list-check" aria-hidden="true"></i><span>How To Use</span></h2>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-examples generate-chmod-shell-markdown-card-commands">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-terminal" aria-hidden="true"></i><span>Example Commands</span></h2>
  <p>Copy a sample, replace the target path, then confirm the generated mode matches the intended file or directory state.</p>

  <pre class="generate-chmod-shell-command-pre"><code>chmod 0644 config/app.conf</code></pre>
  <details class="generate-chmod-shell-command-note">
    <summary>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-closed">Show command use</span>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-open">Hide command use</span>
      <button type="button" class="generate-chmod-shell-command-copy-btn" data-command-copy-index="0"><i class="bi bi-clipboard" aria-hidden="true"></i><span>Copy command</span></button>
    </summary>
  ...
  <pre class="generate-chmod-shell-command-pre"><code>chmod u=rw,g=r,o= deploy.key</code></pre>
  <details class="generate-chmod-shell-command-note">
    <summary>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-closed">Show command use</span>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-open">Hide command use</span>
      <button type="button" class="generate-chmod-shell-command-copy-btn" data-command-copy-index="1"><i class="bi bi-clipboard" aria-hidden="true"></i><span>Copy command</span></button>
    </summary>
  ...
  <pre class="generate-chmod-shell-command-pre"><code>chmod -R u+rwX,g+rX,o-rwx ./release</code></pre>
  <details class="generate-chmod-shell-command-note">
    <summary>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-closed">Show command use</span>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-open">Hide command use</span>
      <button type="button" class="generate-chmod-shell-command-copy-btn" data-command-copy-index="2"><i class="bi bi-clipboard" aria-hidden="true"></i><span>Copy command</span></button>
    </summary>
  ...
  <pre class="generate-chmod-shell-command-pre"><code>chmod --reference=template.conf app.conf</code></pre>
  <details class="generate-chmod-shell-command-note generate-chmod-shell-command-note-last">
    <summary>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-closed">Show command use</span>
      <span class="generate-chmod-shell-command-note-label generate-chmod-shell-command-note-label-open">Hide command use</span>
      <button type="button" class="generate-chmod-shell-command-copy-btn" data-command-copy-index="3"><i class="bi bi-clipboard" aria-hidden="true"></i><span>Copy command</span></button>
    </summary>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-export">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-box-arrow-down" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-faq">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-question-circle" aria-hidden="true"></i><span>FAQ</span></h2>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-glossary">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-book" aria-hidden="true"></i><span>Glossary</span></h2>
...
<div class="content-card generate-chmod-shell-markdown-card generate-chmod-shell-markdown-card-citations">
  <h2 class="generate-chmod-shell-section-heading"><i class="bi bi-journal-text" aria-hidden="true"></i><span>References</span></h2>
  <p>These sources support the in-text citations used in this tool page.</p>

  <table class="generate-chmod-shell-citation-table">
    <thead>
      <tr>
        <th>Source type</th>
    ...
    <tbody>
      <tr id="generate-chmod-shell-ref-primary">
        <td>Manual</td>
        <td><a class="generate-chmod-shell-citation-backlink" href="#generate-chmod-shell-cite-primary"><span class="generate-chmod-shell-citation-inline">(GNU Project, n.d.-a)</span></a></td>
      ...
      <tr id="generate-chmod-shell-ref-method">
        <td>Manual page</td>
        <td><a class="generate-chmod-shell-citation-backlink" href="#generate-chmod-shell-cite-method"><span class="generate-chmod-shell-citation-inline">(Linux man-pages project, 2025)</span></a></td>
      ...
      <tr id="generate-chmod-shell-ref-review">
        <td>Manual</td>
        <td><a class="generate-chmod-shell-citation-backlink" href="#generate-chmod-shell-cite-review"><span class="generate-chmod-shell-citation-inline">(GNU Project, n.d.-b)</span></a></td>
