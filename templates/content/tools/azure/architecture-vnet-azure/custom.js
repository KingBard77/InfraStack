...
installInfraStackResultSummaryNormalizer('architecture-vnet-azure');
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzurePrompt",
            "architectureVnetAzureGenerate",
            "architectureVnetAzureReset",
            "architectureVnetAzureErrorState"
        ],
        "sourceClasses": [
            "tool-prompt-shell",
            "tool-main-row",
            ...
            "architecture-vnet-azure-prompt",
            "architecture-vnet-azure-prompt-hint",
            "architecture-vnet-azure-main-actions",
            "tool-error-state"
        ],
        "sourceVariables": [
            "promptInput",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzurePreset",
            "architectureVnetAzurePresetDescription",
            "architectureVnetAzureRegion",
            "architectureVnetAzureAzCount"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-basic-preset-section",
            "architecture-vnet-azure-basic-grid",
            "architecture-vnet-azure-control-stack",
            "architecture-vnet-azure-native-select",
            "architecture-vnet-azure-custom-select",
            "architecture-vnet-azure-custom-select-trigger",
            "architecture-vnet-azure-custom-select-menu"
        ],
        "sourceVariables": [
            "presetInput",
            "presetDescription",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureNetworkConfigTab",
            "architectureVnetAzureWorkloadConfigTab",
            "architectureVnetAzureServicesConfigTab",
            "architectureVnetAzureNetworkConfigPanel",
            "architectureVnetAzureWorkloadConfigPanel",
            "architectureVnetAzureServicesConfigPanel",
            "architectureVnetAzureCidr",
            "architectureVnetAzureNatMode",
            "architectureVnetAzureAppTier",
            "architectureVnetAzureDatabase",
            "architectureVnetAzureRoute53",
            "architectureVnetAzureCloudFront",
            "architectureVnetAzureWaf",
            "architectureVnetAzureAlb",
            "architectureVnetAzureBastion",
            "architectureVnetAzureEndpoints",
            "architectureVnetAzureFlowLogs",
            "architectureVnetAzureCloudWatch",
            "architectureVnetAzureSiteToSiteVpn",
            "architectureVnetAzureTransitGateway",
            "architectureVnetAzureCache"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-custom-panel",
            "architecture-vnet-azure-custom-panel-summary",
            "architecture-vnet-azure-config-tabs",
            "architecture-vnet-azure-config-tab",
            "architecture-vnet-azure-config-panel",
            "architecture-vnet-azure-config-grid",
            "architecture-vnet-azure-toggle-grid",
            "architecture-vnet-azure-toggle-item"
        ],
        "sourceVariables": [
            "cidrInput",
            "natModeInput",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureSelectedShell",
            "architectureVnetAzureSelectedEmpty",
            "architectureVnetAzureSelectedEditor",
            "architectureVnetAzureSelectedName",
            "architectureVnetAzureSelectedX",
            "architectureVnetAzureSelectedY",
            "architectureVnetAzureSelectedWidth",
            "architectureVnetAzureSelectedHeight",
            "architectureVnetAzureHighlightCard",
            "architectureVnetAzureApplyCardSize",
            "architectureVnetAzureResetCardSize"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-selected-section",
            "architecture-vnet-azure-selected-empty",
            "architecture-vnet-azure-selected-empty-chips",
            "architecture-vnet-azure-selected-hint-chip",
            "architecture-vnet-azure-selected-editor",
            "architecture-vnet-azure-selected-name",
            "architecture-vnet-azure-selected-actions",
            "diagram-card-group",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureStageTitle",
            "architectureVnetAzureStageSubtitle",
            "architectureVnetAzureStageMeta",
            "architectureVnetAzureOutputEmpty",
            "architectureVnetAzurePromptSummary",
            "architectureVnetAzureResultTextGenerated"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-stage-header",
            "architecture-vnet-azure-stage-heading",
            "architecture-vnet-azure-stage-preset-chip",
            "architecture-vnet-azure-stage-meta",
            "architecture-vnet-azure-prompt-notes-card",
            "architecture-vnet-azure-note-card",
            "architecture-vnet-azure-note-copy",
            "tool-empty-state"
        ],
        "sourceVariables": [
            "stageTitle",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureStageShell",
            "architectureVnetAzureStageEmpty",
            "architectureVnetAzureStageCanvas",
            "architectureVnetAzureZoomControl",
            "architectureVnetAzureZoomLabel",
            "architectureVnetAzureZoomInput",
            "architectureVnetAzureZoomOut",
            "architectureVnetAzureZoomIn",
            "architectureVnetAzureZoomFit",
            "architectureVnetAzureZoomActual",
            "architectureVnetAzureUndoStageEdit",
            "architectureVnetAzureHighlightAll",
            "architectureVnetAzureZoomHideUi",
            "architectureVnetAzureUsageHelpButton",
            "architectureVnetAzureUsageHelpPopup",
            "architectureVnetAzureUsageHelpClose",
            "architectureVnetAzureFullscreen",
            "architectureVnetAzureResetLayout"
        ],
        "sourceClasses": [
            "tool-stage-shell",
            "tool-stage-toolbar",
            ...
            "tool-stage-empty",
            "tool-stage-canvas",
            "architecture-vnet-azure-stage-canvas",
            "architecture-vnet-azure-zoom-control",
            "architecture-vnet-azure-icon-btn",
            "architecture-vnet-azure-stage-preview",
            "architecture-vnet-azure-usage-overlay",
            "diagram-root",
            "diagram-card-group",
            "diagram-connector",
            "diagram-connector-hit-target",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureOutputStatus",
            "architectureVnetAzureScoreValue",
            "architectureVnetAzureScoreEchart"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-output-summary",
            "architecture-vnet-azure-output-status-card",
            "architecture-vnet-azure-score-card",
            "architecture-vnet-azure-score-ring-card",
            "architecture-vnet-azure-score-value",
            "architecture-vnet-azure-score-copy",
            "architecture-vnet-azure-score-kicker",
            "architecture-vnet-azure-score-summary",
            "architecture-vnet-azure-score-detail",
            "architecture-vnet-azure-score-tag"
        ],
        "sourceVariables": [
            "outputStatus",
            "scoreRingChart",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureInventorySortSelect",
            "architectureVnetAzureInventorySortSummary",
            "architectureVnetAzureInventorySort",
            "architectureVnetAzureExportPng",
            "architectureVnetAzureDownloadSvg",
            "architectureVnetAzureCopyJson",
            "architectureVnetAzureDownloadJson",
            "architectureVnetAzureImportJsonButton"
        ],
        "sourceClasses": [
            "architecture-vnet-azure-toolbar-shell",
            "architecture-vnet-azure-toolbar",
            "architecture-vnet-azure-toolbar-main",
            "tool-output-toolbar",
            "tool-output-actions",
            "architecture-vnet-azure-sort-label",
            "architecture-vnet-azure-sort-wrap",
            "architecture-vnet-azure-sort-select",
            "architecture-vnet-azure-sort-summary",
            "architecture-vnet-azure-sort-menu",
            "architecture-vnet-azure-sort-option"
        ],
        "sourceVariables": [
            "inventorySortInput",
            "inventorySortSelect",
...
(function attachSourceSection(global) {
    ...
    const source = {
        ...
        "sourceDomIds": [
            "architectureVnetAzureOutputEmpty",
            "architectureVnetAzureOutputContent",
            "architectureVnetAzureInventoryTableBody",
            "architectureVnetAzureRoutingTableBody",
            "architectureVnetAzureControlTableBody",
            "architectureVnetAzurePromptSummary",
            "architectureVnetAzureKeywordList",
            "architectureVnetAzureAssumptionList",
            "architectureVnetAzureModelList",
            "architectureVnetAzureProsList",
            "architectureVnetAzureConsList",
            "architectureVnetAzurePillarBreakdown",
            "architectureVnetAzureRiskLevel",
            "architectureVnetAzureJsonOutput",
            "architectureVnetAzureImportJson"
        ],
        "sourceClasses": [
            "tool-output-shell",
            "tool-empty-state",
            "architecture-vnet-azure-output-content",
            "architecture-vnet-azure-output-shell",
            "architecture-vnet-azure-tabs-shell",
            "tool-tabs",
            "architecture-vnet-azure-tab-btn",
            "architecture-vnet-azure-tab-panel",
            "architecture-vnet-azure-inventory-panel",
            "architecture-vnet-azure-table-card",
            "architecture-vnet-azure-table-wrap",
            "architecture-vnet-azure-table",
            "architecture-vnet-azure-row-copy",
            "architecture-vnet-azure-prompt-notes-card",
            "architecture-vnet-azure-assessment-card",
            "architecture-vnet-azure-pillar-card",
            "architecture-vnet-azure-risk-card",
            "tool-json-shell",
            "architecture-vnet-azure-json-code"
        ],
        "sourceVariables": [
            "outputEmpty",
            "outputContent",
...
// ns:start family.architecture.workspace.04_visual-contract
{{ include('content/tools/azure/architecture-vnet-azure/assets/bin/engine-runtime.js')|raw }}
// ns:end family.architecture.workspace.04_visual-contract
{{ include('content/tools/azure/architecture-vnet-azure/assets/bin/model-core.js')|raw }}

const architectureVnetAzurePresetCatalog = [
    {
        id: 'three-tier-web',
        label: '3-Tier Web',
        description: 'Public Application Gateway, private VM scale sets, Azure SQL, single NAT.',
        prompt: 'Create an Azure VNet architecture in eastus with 2 availability zones. Use public subnets for an internet-facing Application Gateway, private app subnets for Virtual Machine Scale Sets, and private data subnets for Azure SQL. Add a single NAT gateway, Private Endpoints for Blob Storage and Key Vault, Azure Monitor, and NSG flow logs.',
        defaults: {
            region: 'eastus',
            cidr: '10.0.0.0/16',
            azCount: 2,
    ...
    },
    {
        ...
        description: 'Front Door, WAF, container apps, PostgreSQL, Redis, and per-AZ NAT.',
        prompt: 'Build an Azure VNet architecture in westeurope across 2 availability zones for an internet-facing Azure Container Apps platform. Put Azure Front Door and Azure WAF in front of an Application Gateway, keep Azure Container Apps in private app subnets, use Azure Database for PostgreSQL in private data subnets, add Azure Cache for Redis, Private Endpoints, Azure Monitor, NSG flow logs, and one NAT gateway per AZ.',
        defaults: {
            region: 'westeurope',
            cidr: '10.20.0.0/16',
            azCount: 2,
    ...
    },
    {
        id: 'eks-platform',
        label: 'Private AKS',
        description: 'Three AZ platform with private node pools, private endpoints, bastion, and observability.',
        prompt: 'Generate an Azure VNet architecture in southeastasia across 3 availability zones for a private AKS platform. Keep an Application Gateway in public subnets, node pools in private app subnets, Azure Database for PostgreSQL in private data subnets, Azure Bastion for controlled admin access, Private Endpoints, Azure Monitor, and NSG flow logs. Use one NAT gateway per AZ.',
        defaults: {
    ...
    },
    {
        ...
        description: 'VPN Gateway or Virtual WAN connectivity with shared service layers.',
        prompt: 'Design an Azure VNet architecture in westus2 across 2 availability zones for a hybrid environment. Use Azure DNS, an internet-facing Application Gateway, Virtual Machine Scale Sets in private app subnets, Azure SQL in private data subnets, Azure Bastion, Private Endpoints, Azure Monitor, NSG flow logs, VPN Gateway, and Virtual WAN for shared services. Use a single NAT gateway.',
        defaults: {
            region: 'westus2',
            cidr: '10.40.0.0/16',
            azCount: 2,
...
const ARCHITECTURE_VNET_AZURE_TOOL_ID = ArchitectureVnetAzureModelCore.toolId;
const ARCHITECTURE_VNET_AZURE_TOOL_VERSION = ArchitectureVnetAzureModelCore.toolVersion;
const architectureVnetAzureRegionCatalog = ArchitectureVnetAzureModelCore.regionCatalog;
const architectureVnetAzureSupportedRegions = ArchitectureVnetAzureModelCore.supportedRegions;
const architectureVnetAzureAllowedNatModes = ArchitectureVnetAzureModelCore.allowedNatModes;
const architectureVnetAzureAllowedAppTiers = ArchitectureVnetAzureModelCore.allowedAppTiers;
const architectureVnetAzureAllowedDatabases = ArchitectureVnetAzureModelCore.allowedDatabases;
...
document.addEventListener('DOMContentLoaded', function () {
    const promptInput = document.getElementById('architectureVnetAzurePrompt');
    const generateButton = document.getElementById('architectureVnetAzureGenerate');
    const resetButton = document.getElementById('architectureVnetAzureReset');
    const errorState = document.getElementById('architectureVnetAzureErrorState');
    const presetInput = document.getElementById('architectureVnetAzurePreset');
    const presetDescription = document.getElementById('architectureVnetAzurePresetDescription');
    const stageTitle = document.getElementById('architectureVnetAzureStageTitle');
    const stageSubtitle = document.getElementById('architectureVnetAzureStageSubtitle');
    const stageMeta = document.getElementById('architectureVnetAzureStageMeta');
    const stageEmpty = document.getElementById('architectureVnetAzureStageEmpty');
    const stageCanvas = document.getElementById('architectureVnetAzureStageCanvas');
    const stageShell = document.getElementById('architectureVnetAzureStageShell');
    const zoomControl = document.getElementById('architectureVnetAzureZoomControl');
    const zoomLabel = document.getElementById('architectureVnetAzureZoomLabel');
    const zoomInput = document.getElementById('architectureVnetAzureZoomInput');
    const zoomOutButton = document.getElementById('architectureVnetAzureZoomOut');
    const zoomInButton = document.getElementById('architectureVnetAzureZoomIn');
    const zoomFitButton = document.getElementById('architectureVnetAzureZoomFit');
    const zoomActualButton = document.getElementById('architectureVnetAzureZoomActual');
    const undoStageEditButton = document.getElementById('architectureVnetAzureUndoStageEdit');
    const highlightAllButton = document.getElementById('architectureVnetAzureHighlightAll');
    const zoomHideUiButton = document.getElementById('architectureVnetAzureZoomHideUi');
    const usageHelpButton = document.getElementById('architectureVnetAzureUsageHelpButton');
    const usageHelpPopup = document.getElementById('architectureVnetAzureUsageHelpPopup');
    const usageHelpCloseButton = document.getElementById('architectureVnetAzureUsageHelpClose');
    const fullscreenButton = document.getElementById('architectureVnetAzureFullscreen');
    const resetLayoutButton = document.getElementById('architectureVnetAzureResetLayout');
    const outputEmpty = document.getElementById('architectureVnetAzureOutputEmpty');
    const outputContent = document.getElementById('architectureVnetAzureOutputContent');
    const outputStatus = document.getElementById('architectureVnetAzureOutputStatus');
    const pillarBreakdownOutput = document.getElementById('architectureVnetAzurePillarBreakdown');
    const riskLevelOutput = document.getElementById('architectureVnetAzureRiskLevel');
    const inventoryTableBody = document.getElementById('architectureVnetAzureInventoryTableBody');
    const inventorySortInput = document.getElementById('architectureVnetAzureInventorySort');
    const inventorySortSelect = document.getElementById('architectureVnetAzureInventorySortSelect');
    const inventorySortSummary = document.getElementById('architectureVnetAzureInventorySortSummary');
    const inventorySortOptions = Array.from(document.querySelectorAll('.architecture-vnet-azure-sort-option'));
    const jsonOutput = document.getElementById('architectureVnetAzureJsonOutput');
    const promptSummary = document.getElementById('architectureVnetAzurePromptSummary');
    const keywordList = document.getElementById('architectureVnetAzureKeywordList');
    const assumptionList = document.getElementById('architectureVnetAzureAssumptionList');
    const modelList = document.getElementById('architectureVnetAzureModelList');
    const prosList = document.getElementById('architectureVnetAzureProsList');
    const consList = document.getElementById('architectureVnetAzureConsList');
    const selectedEmpty = document.getElementById('architectureVnetAzureSelectedEmpty');
    const selectedEditor = document.getElementById('architectureVnetAzureSelectedEditor');
    const selectedName = document.getElementById('architectureVnetAzureSelectedName');
    const selectedXInput = document.getElementById('architectureVnetAzureSelectedX');
    const selectedYInput = document.getElementById('architectureVnetAzureSelectedY');
    const selectedWidthInput = document.getElementById('architectureVnetAzureSelectedWidth');
    const selectedHeightInput = document.getElementById('architectureVnetAzureSelectedHeight');
    const highlightCardButton = document.getElementById('architectureVnetAzureHighlightCard');
    const applyCardSizeButton = document.getElementById('architectureVnetAzureApplyCardSize');
    const resetCardSizeButton = document.getElementById('architectureVnetAzureResetCardSize');
    const exportPngButton = document.getElementById('architectureVnetAzureExportPng');
    const downloadSvgButton = document.getElementById('architectureVnetAzureDownloadSvg');
    const copyJsonButton = document.getElementById('architectureVnetAzureCopyJson');
    const downloadJsonButton = document.getElementById('architectureVnetAzureDownloadJson');
    const importJsonButton = document.getElementById('architectureVnetAzureImportJsonButton');
    const importJsonInput = document.getElementById('architectureVnetAzureImportJson');
    const tabButtons = Array.from(document.querySelectorAll('.architecture-vnet-azure-tab-btn'));
    const tabPanels = Array.from(document.querySelectorAll('.architecture-vnet-azure-tab-panel'));
    const configTabButtons = Array.from(document.querySelectorAll('.architecture-vnet-azure-config-tab'));
    const configTabPanels = Array.from(document.querySelectorAll('[data-config-panel]'));
    const regionInput = document.getElementById('architectureVnetAzureRegion');
    const cidrInput = document.getElementById('architectureVnetAzureCidr');
    const azCountInput = document.getElementById('architectureVnetAzureAzCount');
    const natModeInput = document.getElementById('architectureVnetAzureNatMode');
    const appTierInput = document.getElementById('architectureVnetAzureAppTier');
    const databaseInput = document.getElementById('architectureVnetAzureDatabase');
    const route53Input = document.getElementById('architectureVnetAzureRoute53');
    const cloudFrontInput = document.getElementById('architectureVnetAzureCloudFront');
    const wafInput = document.getElementById('architectureVnetAzureWaf');
    const albInput = document.getElementById('architectureVnetAzureAlb');
    const bastionInput = document.getElementById('architectureVnetAzureBastion');
    const endpointsInput = document.getElementById('architectureVnetAzureEndpoints');
    const flowLogsInput = document.getElementById('architectureVnetAzureFlowLogs');
    const cloudWatchInput = document.getElementById('architectureVnetAzureCloudWatch');
    const siteToSiteVpnInput = document.getElementById('architectureVnetAzureSiteToSiteVpn');
    const transitGatewayInput = document.getElementById('architectureVnetAzureTransitGateway');
    const cacheInput = document.getElementById('architectureVnetAzureCache');
    ...
    let selectedPresetId = architectureVnetAzurePresetCatalog[0].id;
    ...
    const engineRuntimeConfig = {
        ...
        selectors: {
            ...
            keyboardFormTarget: 'input, textarea, select, button, summary, a[href], [contenteditable="true"], .architecture-vnet-azure-custom-select'
        },
        classes: {
            selected: 'is-selected',
            multiSelected: 'is-multi-selected',
            highlighted: 'is-highlighted',
            diagramHighlighted: 'architecture-vnet-azure-stage-highlight-all',
            dragging: 'architecture-vnet-azure-stage-dragging',
            resizing: 'architecture-vnet-azure-stage-resizing',
            uiHidden: 'architecture-vnet-azure-stage-ui-hidden',
            expanded: 'architecture-vnet-azure-stage-expanded',
            bodyLock: 'architecture-vnet-azure-stage-expanded-lock',
            hidden: 'd-none'
        }
    };
    const diagramShellCardId = 'amazon-vpc-shell';
    const baseStageMinWidth = 1120;
    const stageHeadingTitle = 'Azure VNet Architecture';
    ...
    function renderSelectedEmptyMessage(message) {
        ...
        selectedEmpty.classList.toggle('architecture-vnet-azure-selected-empty-chips', messageText === selectedCardHintText);
        ...
        copy.className = 'architecture-vnet-azure-selected-empty-copy';
        ...
        selectedCardHintChips.forEach(function renderHintChip(chip) {
            ...
            chipElement.className = 'architecture-vnet-azure-selected-hint-chip architecture-vnet-azure-selected-hint-chip-' + chip.tone;
    ...
    function initMarkdownCopyButtons() {
        const promptBlocks = Array.from(document.querySelectorAll('.markdown-content pre.architecture-vnet-azure-prompt-pre'));
        const promptCopyButtons = document.querySelectorAll('.architecture-vnet-azure-prompt-copy-btn');
        ...
        const codeBlocks = document.querySelectorAll('.markdown-content pre:not(.architecture-vnet-azure-prompt-pre)');
    ...
    function applyWorkspaceInfoMarkers() {
        const root = document.querySelector('.architecture-vnet-azure-tool');
        const markerClass = 'architecture-vnet-azure-info-marker';
        ...
        Array.from(root.querySelectorAll([
            ...
            if (!marker) {
                ...
                marker.tabIndex = 0;
                marker.innerHTML = '<span class="architecture-vnet-azure-info-glyph" aria-hidden="true">i</span>';
                element.appendChild(marker);
            }

            let popover = marker.querySelector('.architecture-vnet-azure-info-popover');

            if (!popover) {
                popover = document.createElement('span');
                popover.className = 'architecture-vnet-azure-info-popover';
    ...
    function normalizePrompt(value) {
        return ArchitectureVnetAzureModelCore.normalizePrompt(value);
    }

    function normalizeCidrInput(value) {
        return ArchitectureVnetAzureModelCore.normalizeCidrInput(value);
    }
    ...
    function isValidIpv4Cidr(value) {
        return ArchitectureVnetAzureModelCore.isValidIpv4Cidr(value);
    }

    function parseCidrValue(value) {
        return ArchitectureVnetAzureModelCore.parseCidrValue(value);
    }

    function getCidrValidationMessage() {
        return 'Enter a valid IPv4 VNet CIDR such as 10.0.0.0/16.';
    }
    ...
    function isSupportedImportVersion(version) {
        ...
        return version.split('.')[0] === ARCHITECTURE_VNET_AZURE_TOOL_VERSION.split('.')[0];
    }
    ...
    function buildImportedPayloadState(payload) {
        return ArchitectureVnetAzureModelCore.buildImportedPayloadState(payload, architectureVnetAzurePresetCatalog);
    }
    ...
    function natModeLabel(value) {
        return ArchitectureVnetAzureModelCore.natModeLabel(value);
    }

    function appTierLabel(value) {
        return ArchitectureVnetAzureModelCore.appTierLabel(value);
    }

    function databaseLabel(value) {
        return ArchitectureVnetAzureModelCore.databaseLabel(value);
    }
    ...
    function initializeCustomSelect(selectElement) {
        ...
        wrapper.className = 'architecture-vnet-azure-custom-select';
        button.type = 'button';
        button.className = 'architecture-vnet-azure-custom-select-trigger';
        button.setAttribute('aria-haspopup', 'listbox');
        button.setAttribute('aria-expanded', 'false');
        valueElement.className = 'architecture-vnet-azure-custom-select-value';
        icon.className = 'bi bi-chevron-down';
        icon.setAttribute('aria-hidden', 'true');
        menu.className = 'architecture-vnet-azure-custom-select-menu';
        ...
        selectElement.classList.add('architecture-vnet-azure-native-select');
        ...
        Array.from(selectElement.options).forEach(function (option) {
            ...
            optionButton.className = 'architecture-vnet-azure-custom-select-option';
    ...
    function findPresetById(presetId) {
        return architectureVnetAzurePresetCatalog.find(function (preset) {
            return preset.id === presetId;
        }) || architectureVnetAzurePresetCatalog[0];
    }

    function populateRegionOptions() {
        const currentValue = regionInput.value;

        regionInput.innerHTML = architectureVnetAzureRegionCatalog.map(function (region) {
            return '<option value="' + escapeHtml(region.value) + '">' + escapeHtml(region.label) + '</option>';
        }).join('');

        regionInput.value = architectureVnetAzureSupportedRegions.includes(currentValue)
            ? currentValue
            : architectureVnetAzureRegionCatalog[0].value;
    }
    ...
    function setStageUiHidden(isHidden) {
        ...
        stageShell.classList.toggle('architecture-vnet-azure-stage-ui-hidden', stageUiHidden);
    ...
    function syncStageDiagramHighlight() {
        ...
        stageShell.classList.toggle('architecture-vnet-azure-stage-highlight-all', stageDiagramHighlighted);
    ...
    function updateFullscreenButton() {
        const isFullscreen = document.fullscreenElement === stageShell || stageShell.classList.contains('architecture-vnet-azure-stage-expanded');
    ...
    function setStageExpanded(isExpanded) {
        stageShell.classList.toggle('architecture-vnet-azure-stage-expanded', Boolean(isExpanded));
        document.body.classList.toggle('architecture-vnet-azure-stage-expanded-lock', Boolean(isExpanded));
    ...
    async function toggleFullscreen() {
        try {
            if (stageShell.classList.contains('architecture-vnet-azure-stage-expanded')) {
    ...
    function createToneChip(iconClass, label, tone) {
        return [
            '<span class="architecture-vnet-azure-score-tag architecture-vnet-azure-score-tag-' + escapeHtml(tone) + '">',
    ...
    function extractRegion(prompt, fallbackRegion, assumptions, matchedKeywords) {
        ...
        const matched = architectureVnetAzureSupportedRegions.find(function (region) {
    ...
    function buildPromptTitle(prompt, fallbackLabel) {
        return ArchitectureVnetAzureModelCore.buildPromptTitle(prompt, fallbackLabel);
    }

    function inferFromPrompt(prompt, preset) {
        return ArchitectureVnetAzureModelCore.inferFromPrompt(prompt, preset);
    }
    ...
    function describeInventoryItem(item, spec) {
        ...
        if (component === 'azure vnet') {
            return 'Isolated regional network boundary where subnets, route tables, gateways, private endpoints, and security controls attach to the CIDR range.';
        }

        if (component === 'azure dns') {
            return 'DNS entry point for the application hostname, resolving users toward Azure Front Door when present or directly toward the ingress tier.';
        }

        if (component === 'azure front door') {
        ...
        if (component === 'application gateway') {
        ...
        if (component.indexOf('azure sql subnet ') === 0 || component.indexOf('azure database for postgresql subnet ') === 0) {
        ...
        if (component === 'virtual machine scale sets') {
        ...
        if (component === 'azure container apps') {
        ...
        if (component === 'azure functions in vnet') {
        ...
        if (component === 'azure cosmos db') {
            return 'Regional managed data tier outside the VNet boundary, normally reached privately through private endpoints when enabled.';
        }

        if (component === 'azure cache for redis') {
            return 'Private in-memory cache tier used by application services for low-latency state, sessions, or query acceleration.';
        }

        if (component === 'private endpoints') {
            return 'Private Azure service access path for services such as Storage and Key Vault without depending on public internet routing.';
        }

        if (component === 'azure bastion') {
            return 'Hardened administrative jump host in the public tier for controlled access into private resources.';
        }

        if (component === 'vpn gateway') {
            return 'Encrypted hybrid connectivity path between on-premises networks and the VNet routing domain.';
        }

        if (component === 'virtual wan') {
            return 'Regional routing hub for shared services, additional VNets, and hybrid attachments with centralized route control.';
        }

        if (component === 'azure monitor') {
            return 'Operations plane for metrics, alarms, logs, dashboards, and service visibility across the generated architecture.';
        }

        if (component === 'nsg flow logs') {
    ...
    function buildInventory(spec) {
        ...
        if (spec.waf) {
            inventory.push({
                component: 'Azure WAF',
                placement: 'Edge',
                purpose: 'Request filtering before the VNet ingress path'
            });
        }
        ...
        if (spec.database === 'dynamodb') {
            inventory.push({
                ...
                placement: 'Managed service outside the VNet',
        ...
        if (spec.cache) {
            inventory.push({
                ...
                placement: spec.database === 'none' && spec.azCount === 1 ? 'Shared VNet tier' : 'Private data services',
        ...
        if (spec.endpoints) {
            inventory.push({
                ...
                purpose: 'Private connectivity to Azure managed services'
            });
        }
        ...
        if (spec.siteToSiteVpn) {
            inventory.push({
                ...
                purpose: 'Extends on-premises connectivity into the VNet'
            });
        }
        ...
        if (spec.transitGateway) {
            inventory.push({
                ...
                purpose: 'Connects the VNet to shared services or additional networks'
            });
        }
    ...
    function buildModelSummary(spec) {
        ...
        if (spec.route53) {
            summary.push('Azure DNS');
        }

        if (spec.cloudFront) {
            summary.push('Azure Front Door');
        }

        if (spec.waf) {
            summary.push('Azure WAF');
        }

        if (spec.endpoints) {
            summary.push('Private Endpoints');
        }
    ...
    function buildArchitectureProsCons(spec) {
        ...
        if (spec.alb) {
            pros.push('Application Gateway separates public ingress from private workloads.');
        } else {
        ...
        if (spec.database === 'rds' || spec.database === 'aurora') {
            ...
            pros.push('Azure Cosmos DB removes database subnet and instance management from the VNet path.');
        } else {
            cons.push('No managed database tier is represented in the architecture.');
        }

        if (spec.endpoints) {
            pros.push('Private Endpoints reduce dependency on public internet paths for Azure service access.');
        } else {
            cons.push('Private workloads may rely on NAT or public paths for Azure service APIs.');
        }

        if (spec.cloudWatch && spec.flowLogs) {
            pros.push('Azure Monitor and NSG flow logs give the design baseline observability.');
        } else if (spec.cloudWatch || spec.flowLogs) {
            cons.push('Observability is partial; pair Azure Monitor with flow logs for better operations coverage.');
        } else {
        ...
        if (spec.route53 && spec.cloudFront && spec.waf) {
            pros.push('Azure DNS, Front Door, and Azure WAF create a stronger edge entry path.');
        } else if (!spec.waf && (spec.alb || spec.cloudFront)) {
            cons.push('No Azure WAF layer is modeled in front of public HTTP ingress.');
        }
    ...
    function buildRiskLevel(spec) {
        ...
        let detail = 'Review identity, NSGs, route tables, and data protection settings before production change approval.';
        ...
        if (scorePayload.score < 65 || consCount >= 5) {
            ...
            detail = 'Prioritize availability zones, ingress protection, private routing, and monitoring before using this as a delivery baseline.';
            ...
            detail = 'Validate NAT placement, private endpoint coverage, and operational ownership before rollout.';
        }
    ...
    function inferEdgeCards(spec) {
        ...
        if (spec.route53) {
            cards.push({ id: 'route53', label: 'Azure DNS', short: 'DNS', tone: 'service' });
        }

        if (spec.cloudFront) {
            cards.push({ id: 'cloudfront', label: 'Azure Front Door', short: 'AFD', tone: 'service' });
        }

        if (spec.waf) {
            cards.push({ id: 'waf', label: 'Azure WAF', short: 'WAF', tone: 'security' });
        }
    ...
    function resolveCardIconHref(card) {
        if (!card.iconKey || !Object.prototype.hasOwnProperty.call(architectureVnetAzureIconSvgMap, card.iconKey)) {
            return '';
        }

        return buildSvgDataUri(architectureVnetAzureIconSvgMap[card.iconKey]);
    }
    ...
    function cloneLayoutOverrides(layoutOverrides) {
        if (architectureVnetAzureEngineRuntime && typeof architectureVnetAzureEngineRuntime.cloneLayoutOverrides === 'function') {
            return architectureVnetAzureEngineRuntime.cloneLayoutOverrides(layoutOverrides);
        }

        return ArchitectureVnetAzureModelCore.cloneLayoutOverrides(layoutOverrides);
    }

    function cloneConnectorOverrides(connectorOverrides) {
        if (architectureVnetAzureEngineRuntime && typeof architectureVnetAzureEngineRuntime.cloneConnectorOverrides === 'function') {
            return architectureVnetAzureEngineRuntime.cloneConnectorOverrides(connectorOverrides);
        }

        return ArchitectureVnetAzureModelCore.cloneConnectorOverrides(connectorOverrides);
    }
    ...
    function currentViewportState() {
        return {
            ...
            fullscreen: Boolean(stageShell && (document.fullscreenElement === stageShell || stageShell.classList.contains('architecture-vnet-azure-stage-expanded'))),
    ...
    function createEngineState(value) {
        ...
        if (architectureVnetAzureEngineRuntime && typeof architectureVnetAzureEngineRuntime.createState === 'function') {
            return architectureVnetAzureEngineRuntime.createState(stateValue, engineRuntimeConfig);
        }
    ...
    function toPersistedEngineState(value) {
        ...
        if (architectureVnetAzureEngineRuntime && typeof architectureVnetAzureEngineRuntime.toPersistedState === 'function') {
            return architectureVnetAzureEngineRuntime.toPersistedState(state, engineRuntimeConfig);
        }
    ...
    function renderCardConnector(sourceCard, targetCard, options) {
        ...
        const markerId = resolvedOptions.active ? 'architectureVnetAzureArrowActive' : 'architectureVnetAzureArrow';
    ...
    function renderVpcShell(shell) {
        ...
        return [
            ...
            iconImage,
            buildMultilineText(shell.x + 60, shell.y + 34, ['Azure VNet'], 'diagram-vpc-title', 16),
    ...
    function buildSvgMarkup(spec, layoutOverrides, connectorOverrides) {
        ...
        if (spec.siteToSiteVpn) {
            ...
            connectors.push(renderCardConnector(vpnCard, vpcShell, {
                    id: 'site-to-site-vpn-to-azure-vnet',
                sourceSide: 'right',
                targetSide: 'left',
        ...
        if (spec.transitGateway) {
            ...
            connectors.push(renderCardConnector(transitGatewayCard, vpcShell, {
                    id: 'transit-gateway-to-azure-vnet',
                sourceSide: 'right',
                targetSide: 'left',
        ...
        if (spec.endpoints) {
            addRightRailCard({
                ...
                short: 'EP',
                subtitle: ['Private Blob and Key Vault access'],
                tone: 'service',
        ...
        cards.forEach(function (card) {
            if (card.id === 'cloudwatch' || card.id === 'vpc-flow-logs' || card.id === 'vpc-endpoints') {
                connectors.push(renderCardConnector(vpcShell, card, {
                    id: 'architecture-vnet-azure-to-' + card.id,
                    sourceSide: 'right',
                    targetSide: 'left',
        ...
        return {
            svgMarkup: [
                ...
                '.diagram-vpc{fill:#ffffff;stroke:#7ec1e8;stroke-width:2;}',
                ...
                '.diagram-vpc-title{fill:#1E3A8A;font-size:var(--diagram-font-title);font-weight:800;}',
                '.diagram-vpc-meta{fill:#1E3A8A;font-size:var(--diagram-font-meta);font-weight:600;}',
                ...
                '.diagram-card-highlight{display:none;fill:rgba(6,182,212,0.1);stroke:#06B6D4;stroke-width:3;stroke-dasharray:10 7;pointer-events:none;filter:drop-shadow(0 10px 18px rgba(6,182,212,0.22));}',
                '.diagram-card-group.is-selected .diagram-card-highlight{display:block;}',
                '.diagram-card-group.is-highlighted .diagram-card-highlight{display:block;stroke:#2563eb;stroke-width:4;filter:drop-shadow(0 12px 22px rgba(37,99,235,0.28));}',
                '.diagram-card-group.is-marquee-target .diagram-card-highlight{display:block;stroke:#06B6D4;stroke-width:3;filter:drop-shadow(0 12px 22px rgba(6,182,212,0.24));}',
                '.diagram-content-highlight{display:none;fill:rgba(6,182,212,0.06);stroke:#06B6D4;stroke-width:5;stroke-dasharray:18 10;pointer-events:none;filter:drop-shadow(0 16px 28px rgba(6,182,212,0.2));}',
                ...
                '.diagram-zone-label{fill:#1E3A8A;font-size:var(--diagram-font-zone-label);font-weight:800;}',
                ...
                '.diagram-connector-anchor-handle{fill:#ffffff;stroke:#2563EB;stroke-width:2;cursor:grab;pointer-events:all;filter:drop-shadow(0 4px 8px rgba(37,99,235,0.24));}',
                '.diagram-connector-anchor-handle:active{cursor:grabbing;}',
                '.diagram-connector-bend-handle{fill:#2563EB;stroke:#ffffff;stroke-width:2;cursor:move;pointer-events:all;filter:drop-shadow(0 4px 8px rgba(37,99,235,0.28));}',
                ...
                ']]></style>',
                '<marker id="architectureVnetAzureArrow" markerWidth="11" markerHeight="11" refX="10" refY="5.5" orient="auto" markerUnits="userSpaceOnUse">',
                '<path d="M 0 0 L 11 5.5 L 0 11 z" fill="#111827"></path>',
                '</marker>',
                '<marker id="architectureVnetAzureArrowActive" markerWidth="11" markerHeight="11" refX="10" refY="5.5" orient="auto" markerUnits="userSpaceOnUse">',
                '<path d="M 0 0 L 11 5.5 L 0 11 z" fill="#111827"></path>',
                '</marker>',
                '</defs>',
    ...
    function buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides) {
        return applyVisualStateToExportPayload(ArchitectureVnetAzureModelCore.buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides, buildNotePayload(spec)));
    }
    ...
    function renderNotes(spec) {
        ...
        keywordList.innerHTML = notePayload.matched_keywords.length > 0
            ...
            : '<li>No explicit Azure keywords were matched. The diagram relies on the selected preset and inspector controls.</li>';
    ...
    function renderAssessmentSections(spec) {
        ...
        pillarBreakdownOutput.className = 'architecture-vnet-azure-assessment-card architecture-vnet-azure-pillar-card';
        riskLevelOutput.className = 'architecture-vnet-azure-assessment-card architecture-vnet-azure-risk-card architecture-vnet-azure-risk-card-' + risk.tone;

        pillarBreakdownOutput.innerHTML = [
            '<h3 class="architecture-vnet-azure-result-section-title">Pillar Breakdown</h3>',
            '<div class="architecture-vnet-azure-pillar-list">',
            pillars.map(function (pillar) {
                return [
                    '<div class="architecture-vnet-azure-pillar-row architecture-vnet-azure-pillar-row-' + escapeHtml(pillar.tone) + '">',
                    '<span class="architecture-vnet-azure-pillar-icon" aria-hidden="true"><i class="' + escapeHtml(pillar.icon) + '"></i></span>',
                    '<span class="architecture-vnet-azure-pillar-name">' + escapeHtml(pillar.label) + '</span>',
                    '<span class="architecture-vnet-azure-pillar-meter" aria-hidden="true"><span style="--pillar-score: ' + escapeHtml(String(pillar.score)) + '%;"></span></span>',
                    '<span class="architecture-vnet-azure-pillar-score"><strong>' + escapeHtml(String(pillar.score)) + '</strong> /100</span>',
                    '</div>'
                ].join('');
            }).join(''),
            '</div>',
            '<div class="architecture-vnet-azure-pillar-legend" aria-label="Pillar score legend">',
            '<span><i class="architecture-vnet-azure-legend-dot architecture-vnet-azure-legend-dot-excellent"></i>Excellent (90-100)</span>',
            '<span><i class="architecture-vnet-azure-legend-dot architecture-vnet-azure-legend-dot-good"></i>Good (70-89)</span>',
            '<span><i class="architecture-vnet-azure-legend-dot architecture-vnet-azure-legend-dot-fair"></i>Fair (50-69)</span>',
            '<span><i class="architecture-vnet-azure-legend-dot architecture-vnet-azure-legend-dot-needs"></i>Needs improvement (&lt;50)</span>',
            '</div>'
        ].join('');

        riskLevelOutput.innerHTML = [
            '<h3 class="architecture-vnet-azure-result-section-title">Risk Level</h3>',
            '<div class="architecture-vnet-azure-risk-body">',
            '<div class="architecture-vnet-azure-risk-icon" aria-hidden="true"><i class="' + escapeHtml(risk.icon) + '"></i></div>',
            '<div class="architecture-vnet-azure-risk-copy">',
            '<div class="architecture-vnet-azure-risk-level">' + escapeHtml(risk.level) + '</div>',
            '<p>' + escapeHtml(risk.summary) + '<br>' + escapeHtml(risk.detail) + '</p>',
            '</div>',
            '</div>',
            '<div class="architecture-vnet-azure-risk-meta">',
            '<div>',
            '<span>Generated</span>',
    ...
    function renderOutputScore(spec) {
        ...
        const tagChips = scorePayload.tags.map(function (item) {
            return [
                '<span class="architecture-vnet-azure-result-chip architecture-vnet-azure-result-chip-' + chipTone(item.tone) + '">',
                '<span class="architecture-vnet-azure-result-chip-icon"><i class="' + escapeHtml(item.icon) + '" aria-hidden="true"></i></span>',
                escapeHtml(item.label),
                '</span>'
            ].join('');
        }).join('');

        outputStatus.className = 'architecture-vnet-azure-score-card architecture-vnet-azure-result-summary';
        outputStatus.dataset.resultTone = resultTone;
        outputStatus.dataset.resultLayout = 'architecture_score';
        outputStatus.innerHTML = [
            '<div class="architecture-vnet-azure-result-hero-grid" aria-live="polite">',
            '<article class="architecture-vnet-azure-result-card architecture-vnet-azure-result-card-main">',
            '<span class="architecture-vnet-azure-result-kicker">Architecture score</span>',
            '<h3 class="architecture-vnet-azure-result-title">' + escapeHtml(scorePayload.band) + '</h3>',
            '<p class="architecture-vnet-azure-result-copy">' + escapeHtml(scorePayload.detail) + '</p>',
            '<div class="architecture-vnet-azure-result-chip-row" aria-label="Architecture score state">',
            '<span class="architecture-vnet-azure-result-chip architecture-vnet-azure-result-chip-' + chipTone(scorePayload.badgeTone) + '"><span class="architecture-vnet-azure-result-chip-icon"><i class="' + escapeHtml(scorePayload.badgeIcon) + '" aria-hidden="true"></i></span>' + escapeHtml(scorePayload.badgeLabel) + '</span>',
            tagChips,
            '</div>',
            '</article>',
            '<article class="architecture-vnet-azure-result-card architecture-vnet-azure-result-card-visual">',
            '<div class="architecture-vnet-azure-result-ring architecture-vnet-azure-score-value" id="architectureVnetAzureScoreValue" style="--architecture-vnet-azure-result-progress: ' + escapeHtml(String(ringProgressAngle)) + 'deg; --progress-angle: ' + escapeHtml(String(ringProgressAngle)) + 'deg;" aria-label="Architecture score ' + escapeHtml(String(scorePayload.score)) + ' out of 100">',
            '<div class="architecture-vnet-azure-score-echart" id="architectureVnetAzureScoreEchart" aria-hidden="true"></div>',
            '<div class="architecture-vnet-azure-result-ring-center architecture-vnet-azure-score-center">',
            '<span class="architecture-vnet-azure-result-ring-value architecture-vnet-azure-score-value-number">' + escapeHtml(String(scorePayload.score)) + '</span>',
            '<span class="architecture-vnet-azure-result-ring-unit architecture-vnet-azure-score-caption">/100</span>',
            '</div>',
            '</div>',
            '<div class="architecture-vnet-azure-result-visual-copy">',
            '<span class="architecture-vnet-azure-result-kicker">Primary result</span>',
            '<h3 class="architecture-vnet-azure-result-title architecture-vnet-azure-result-title-center">' + escapeHtml(scorePayload.ringLabel) + '</h3>',
            '</div>',
            '</article>',
            '</div>',
            '<div class="architecture-vnet-azure-result-metric-grid" aria-label="Architecture metrics">',
            '<article class="architecture-vnet-azure-result-metric-card"><span class="architecture-vnet-azure-result-metric-label">Region</span><strong class="architecture-vnet-azure-result-metric-value">' + escapeHtml(spec.region) + '</strong><span class="architecture-vnet-azure-result-metric-copy">Selected deployment geography.</span></article>',
            '<article class="architecture-vnet-azure-result-metric-card"><span class="architecture-vnet-azure-result-metric-label">Zones</span><strong class="architecture-vnet-azure-result-metric-value">' + escapeHtml(String(spec.azCount) + ' AZ') + '</strong><span class="architecture-vnet-azure-result-metric-copy">Availability zone spread.</span></article>',
            '<article class="architecture-vnet-azure-result-metric-card"><span class="architecture-vnet-azure-result-metric-label">Egress</span><strong class="architecture-vnet-azure-result-metric-value">' + escapeHtml(natModeLabel(spec.natMode)) + '</strong><span class="architecture-vnet-azure-result-metric-copy">Private tier outbound pattern.</span></article>',
            '<article class="architecture-vnet-azure-result-metric-card"><span class="architecture-vnet-azure-result-metric-label">Data tier</span><strong class="architecture-vnet-azure-result-metric-value">' + escapeHtml(databaseLabel(spec.database)) + '</strong><span class="architecture-vnet-azure-result-metric-copy">Modeled persistence layer.</span></article>',
            '</div>'
        ].join('');
    }
    ...
    function renderStageHeader(spec) {
        ...
        stageSubtitle.innerHTML = '<span class="architecture-vnet-azure-stage-preset-chip" title="' + escapeHtml(presetChipLabel) + '">' + escapeHtml(presetChipLabel) + '</span>';
    }
    ...
    function isKeyboardFormTarget(target) {
        ...
        return target.closest('input, textarea, select, button, summary, a[href], [contenteditable="true"], .architecture-vnet-azure-custom-select') !== null;
    }
    ...
    function renderResult(spec, layoutOverrides, connectorOverrides, options) {
        ...
        stageCanvas.classList.remove('architecture-vnet-azure-stage-preview');
        ...
        normalizeInfraStackResultSummary('architecture-vnet-azure');
    ...
    function createPresetPreviewOverlay() {
        return [
            '<div class="architecture-vnet-azure-stage-preview-overlay" role="status">',
            '<div class="architecture-vnet-azure-stage-preview-panel">',
            '<span class="architecture-vnet-azure-stage-preview-icon"><i class="bi bi-stars" aria-hidden="true"></i></span>',
    ...
    function renderPresetPreview(preset, options) {
        ...
        stageCanvas.classList.add('architecture-vnet-azure-stage-preview');
    ...
    function generateFromPrompt() {
        ...
        if (prompt === '') {
            showError('Add an Azure VNet brief before generating the diagram.');
            return;
        }
    ...
    function resetToDefault() {
        applyPreset(architectureVnetAzurePresetCatalog[0].id, true);
    }
    ...
    function downloadSvg() {
        ...
        downloadFile('architecture-vnet-azure.svg', latestResult.svgMarkup, 'image/svg+xml;charset=utf-8');
    }
            ...
            image.onload = function () {
                ...
                if (context) {
                    ...
                    canvas.toBlob(function (blob) {
                        ...
                        downloadFile('architecture-vnet-azure.png', blob, 'image/png');
    ...
    function downloadJson() {
        ...
        downloadFile('architecture-vnet-azure.json', JSON.stringify(latestResult.exportPayload, null, 2), 'application/json;charset=utf-8');
    }
    ...
    presetInput.addEventListener('change', function () {
        applyPreset(String(presetInput.value || architectureVnetAzurePresetCatalog[0].id), true);
    });

    tabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateTab(String(button.dataset.tabTarget || 'architectureVnetAzureInventoryPanel'));
        });
    });
    ...
    configTabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateConfigTab(String(button.dataset.configTabTarget || 'architectureVnetAzureNetworkConfigPanel'));
        });
    });
    ...
    document.addEventListener('keydown', function (event) {
        if (event.key === 'Escape' && stageShell.classList.contains('architecture-vnet-azure-stage-expanded')) {
            setStageExpanded(false);
        }
    });
    ...
    inventoryTableBody.addEventListener('click', function (event) {
        const button = event.target.closest('.architecture-vnet-azure-row-copy');
    ...
    document.addEventListener('click', function (event) {
        if (event.target.closest('.architecture-vnet-azure-custom-select')) {
            return;
        }
    ...
    activateTab('architectureVnetAzureInventoryPanel');
    activateConfigTab('architectureVnetAzureNetworkConfigPanel');
    updateFullscreenButton();
    applyStageZoom();
    updatePresetSelection();
...
(function setupArchitectureVnetAzureTableOutputStandard() {
    const rootSelector = '.architecture-vnet-azure-tool';
    const tableSelector = '.tool-result-table tbody tr, .architecture-vnet-azure-table tbody tr';
    const tbodySelector = '.tool-result-table tbody, .architecture-vnet-azure-table tbody';
    const clampClass = 'architecture-vnet-azure-table-cell-text';
    const cellClampClass = 'architecture-vnet-azure-cell-clamp';
    const statusColumnClass = 'architecture-vnet-azure-table-status-cell';
    ...
    function applyStatusAlignment(root) {
        root.querySelectorAll('.tool-result-table, .architecture-vnet-azure-table').forEach(function alignStatusTable(table) {
