...
{{ include('content/tools/azure/azure-vnet-architecture/assets/bin/model-core.js')|raw }}

const azureVnetPresetCatalog = [
    {
        id: 'three-tier-web',
        label: '3-Tier Web',
...
const AZURE_VNET_TOOL_ID = AzureVnetModelCore.toolId;
const AZURE_VNET_TOOL_VERSION = AzureVnetModelCore.toolVersion;
const azureVnetRegionCatalog = AzureVnetModelCore.regionCatalog;
const azureVnetSupportedRegions = AzureVnetModelCore.supportedRegions;
const azureVnetAllowedNatModes = AzureVnetModelCore.allowedNatModes;
const azureVnetAllowedAppTiers = AzureVnetModelCore.allowedAppTiers;
const azureVnetAllowedDatabases = AzureVnetModelCore.allowedDatabases;

const azureVnetIconSvgMap = {
    amazonVpc: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Virtual-Networks.svg')|json_encode|raw }},
    route53: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-DNS-Zones.svg')|json_encode|raw }},
    cloudFront: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Front-Door-and-CDN-Profiles.svg')|json_encode|raw }},
    waf: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Web-Application-Firewall-Policies.svg')|json_encode|raw }},
    internetGateway: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Public-IP-Addresses.svg')|json_encode|raw }},
    applicationLoadBalancer: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Application-Gateways.svg')|json_encode|raw }},
    vpcRouter: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Virtual-Router.svg')|json_encode|raw }},
    natGateway: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-NAT.svg')|json_encode|raw }},
    ec2: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Virtual-Machine.svg')|json_encode|raw }},
    ec2AutoScaling: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-VM-Scale-Sets.svg')|json_encode|raw }},
    ecs: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Worker-Container-App.svg')|json_encode|raw }},
    eks: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Kubernetes-Services.svg')|json_encode|raw }},
    fargate: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Worker-Container-App.svg')|json_encode|raw }},
    lambda: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Function-Apps.svg')|json_encode|raw }},
    rds: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-SQL.svg')|json_encode|raw }},
    aurora: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Database-PostgreSQL-Server.svg')|json_encode|raw }},
    dynamodb: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Cosmos-DB.svg')|json_encode|raw }},
    elasticache: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Cache-Redis.svg')|json_encode|raw }},
    vpcEndpoints: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Private-Endpoints.svg')|json_encode|raw }},
    vpcFlowLogs: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Network-Watcher.svg')|json_encode|raw }},
    cloudWatch: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Monitor.svg')|json_encode|raw }},
    systemsManager: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Key-Vaults.svg')|json_encode|raw }},
    siteToSiteVpn: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Virtual-Network-Gateways.svg')|json_encode|raw }},
    transitGateway: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Virtual-WANs.svg')|json_encode|raw }},
    bastion: {{ include('content/tools/azure/azure-vnet-architecture/assets/icon/Azure-Bastions.svg')|json_encode|raw }}
};

document.addEventListener('DOMContentLoaded', function () {
    const promptInput = document.getElementById('azureVnetPrompt');
    const generateButton = document.getElementById('azureVnetGenerate');
    const resetButton = document.getElementById('azureVnetReset');
    const errorState = document.getElementById('azureVnetErrorState');
    const presetInput = document.getElementById('azureVnetPreset');
    const presetDescription = document.getElementById('azureVnetPresetDescription');
    const stageTitle = document.getElementById('azureVnetStageTitle');
    const stageSubtitle = document.getElementById('azureVnetStageSubtitle');
    const stageMeta = document.getElementById('azureVnetStageMeta');
    const stageEmpty = document.getElementById('azureVnetStageEmpty');
    const stageCanvas = document.getElementById('azureVnetStageCanvas');
    const stageShell = document.getElementById('azureVnetStageShell');
    const zoomControl = document.getElementById('azureVnetZoomControl');
    const zoomLabel = document.getElementById('azureVnetZoomLabel');
    const zoomInput = document.getElementById('azureVnetZoomInput');
    const zoomOutButton = document.getElementById('azureVnetZoomOut');
    const zoomInButton = document.getElementById('azureVnetZoomIn');
    const zoomFitButton = document.getElementById('azureVnetZoomFit');
    const zoomActualButton = document.getElementById('azureVnetZoomActual');
    const zoomHideUiButton = document.getElementById('azureVnetZoomHideUi');
    const fullscreenButton = document.getElementById('azureVnetFullscreen');
    const resetLayoutButton = document.getElementById('azureVnetResetLayout');
    const outputEmpty = document.getElementById('azureVnetOutputEmpty');
    const outputContent = document.getElementById('azureVnetOutputContent');
    const outputStatus = document.getElementById('azureVnetOutputStatus');
    const inventoryTableBody = document.getElementById('azureVnetInventoryTableBody');
    const inventorySortInput = document.getElementById('azureVnetInventorySort');
    const inventorySortSelect = document.getElementById('azureVnetInventorySortSelect');
    const inventorySortSummary = document.getElementById('azureVnetInventorySortSummary');
    const inventorySortOptions = Array.from(document.querySelectorAll('.azure-vnet-sort-option'));
    const jsonOutput = document.getElementById('azureVnetJsonOutput');
    const promptSummary = document.getElementById('azureVnetPromptSummary');
    const keywordList = document.getElementById('azureVnetKeywordList');
    const assumptionList = document.getElementById('azureVnetAssumptionList');
    const modelList = document.getElementById('azureVnetModelList');
    const prosList = document.getElementById('azureVnetProsList');
    const consList = document.getElementById('azureVnetConsList');
    const selectedEmpty = document.getElementById('azureVnetSelectedEmpty');
    const selectedEditor = document.getElementById('azureVnetSelectedEditor');
    const selectedName = document.getElementById('azureVnetSelectedName');
    const selectedXInput = document.getElementById('azureVnetSelectedX');
    const selectedYInput = document.getElementById('azureVnetSelectedY');
    const selectedWidthInput = document.getElementById('azureVnetSelectedWidth');
    const selectedHeightInput = document.getElementById('azureVnetSelectedHeight');
    const applyCardSizeButton = document.getElementById('azureVnetApplyCardSize');
    const resetCardSizeButton = document.getElementById('azureVnetResetCardSize');
    const exportPngButton = document.getElementById('azureVnetExportPng');
    const downloadSvgButton = document.getElementById('azureVnetDownloadSvg');
    const copyJsonButton = document.getElementById('azureVnetCopyJson');
    const downloadJsonButton = document.getElementById('azureVnetDownloadJson');
    const importJsonButton = document.getElementById('azureVnetImportJsonButton');
    const importJsonInput = document.getElementById('azureVnetImportJson');
    const tabButtons = Array.from(document.querySelectorAll('.azure-vnet-tab-btn'));
    const tabPanels = Array.from(document.querySelectorAll('.azure-vnet-tab-panel'));
    const configTabButtons = Array.from(document.querySelectorAll('.azure-vnet-config-tab'));
    const configTabPanels = Array.from(document.querySelectorAll('[data-config-panel]'));
    const regionInput = document.getElementById('azureVnetRegion');
    const cidrInput = document.getElementById('azureVnetCidr');
    const azCountInput = document.getElementById('azureVnetAzCount');
    const natModeInput = document.getElementById('azureVnetNatMode');
    const appTierInput = document.getElementById('azureVnetAppTier');
    const databaseInput = document.getElementById('azureVnetDatabase');
    const route53Input = document.getElementById('azureVnetRoute53');
    const cloudFrontInput = document.getElementById('azureVnetCloudFront');
    const wafInput = document.getElementById('azureVnetWaf');
    const albInput = document.getElementById('azureVnetAlb');
    const bastionInput = document.getElementById('azureVnetBastion');
    const endpointsInput = document.getElementById('azureVnetEndpoints');
    const flowLogsInput = document.getElementById('azureVnetFlowLogs');
    const cloudWatchInput = document.getElementById('azureVnetCloudWatch');
    const siteToSiteVpnInput = document.getElementById('azureVnetSiteToSiteVpn');
    const transitGatewayInput = document.getElementById('azureVnetTransitGateway');
    const cacheInput = document.getElementById('azureVnetCache');
    ...
    let selectedPresetId = azureVnetPresetCatalog[0].id;
    ...
    function initMarkdownCopyButtons() {
        const promptBlocks = Array.from(document.querySelectorAll('.markdown-content pre.azure-vnet-prompt-pre'));
        const promptCopyButtons = document.querySelectorAll('.azure-vnet-prompt-copy-btn');
        ...
        const codeBlocks = document.querySelectorAll('.markdown-content pre:not(.azure-vnet-prompt-pre)');
    ...
    function normalizePrompt(value) {
        return AzureVnetModelCore.normalizePrompt(value);
    }

    function normalizeCidrInput(value) {
        return AzureVnetModelCore.normalizeCidrInput(value);
    }
    ...
    function isValidIpv4Cidr(value) {
        return AzureVnetModelCore.isValidIpv4Cidr(value);
    }

    function parseCidrValue(value) {
        return AzureVnetModelCore.parseCidrValue(value);
    }
    ...
    function isSupportedImportVersion(version) {
        ...
        return version.split('.')[0] === AZURE_VNET_TOOL_VERSION.split('.')[0];
    }
    ...
    function buildImportedPayloadState(payload) {
        return AzureVnetModelCore.buildImportedPayloadState(payload, azureVnetPresetCatalog);
    }

    function natModeLabel(value) {
        return AzureVnetModelCore.natModeLabel(value);
    }

    function appTierLabel(value) {
        return AzureVnetModelCore.appTierLabel(value);
    }

    function databaseLabel(value) {
        return AzureVnetModelCore.databaseLabel(value);
    }
    ...
    function initializeCustomSelect(selectElement) {
        ...
        wrapper.className = 'azure-vnet-custom-select';
        button.type = 'button';
        button.className = 'azure-vnet-custom-select-trigger';
        button.setAttribute('aria-haspopup', 'listbox');
        button.setAttribute('aria-expanded', 'false');
        valueElement.className = 'azure-vnet-custom-select-value';
        icon.className = 'bi bi-chevron-down';
        icon.setAttribute('aria-hidden', 'true');
        menu.className = 'azure-vnet-custom-select-menu';
        ...
        selectElement.classList.add('azure-vnet-native-select');
        ...
        Array.from(selectElement.options).forEach(function (option) {
            ...
            optionButton.className = 'azure-vnet-custom-select-option';
    ...
    function findPresetById(presetId) {
        return azureVnetPresetCatalog.find(function (preset) {
            return preset.id === presetId;
        }) || azureVnetPresetCatalog[0];
    }

    function populateRegionOptions() {
        const currentValue = regionInput.value;

        regionInput.innerHTML = azureVnetRegionCatalog.map(function (region) {
            return '<option value="' + escapeHtml(region.value) + '">' + escapeHtml(region.label) + '</option>';
        }).join('');

        regionInput.value = azureVnetSupportedRegions.includes(currentValue)
            ? currentValue
            : azureVnetRegionCatalog[0].value;
    }
    ...
    function setStageUiHidden(isHidden) {
        ...
        stageShell.classList.toggle('azure-vnet-stage-ui-hidden', stageUiHidden);
    ...
    function updateFullscreenButton() {
        const isFullscreen = document.fullscreenElement === stageShell || stageShell.classList.contains('azure-vnet-stage-expanded');
    ...
    function setStageExpanded(isExpanded) {
        stageShell.classList.toggle('azure-vnet-stage-expanded', Boolean(isExpanded));
        document.body.classList.toggle('azure-vnet-stage-expanded-lock', Boolean(isExpanded));
    ...
    async function toggleFullscreen() {
        try {
            if (stageShell.classList.contains('azure-vnet-stage-expanded')) {
    ...
    function createToneChip(iconClass, label, tone) {
        return [
            '<span class="azure-vnet-score-tag azure-vnet-score-tag-' + escapeHtml(tone) + '">',
    ...
    function extractRegion(prompt, fallbackRegion, assumptions, matchedKeywords) {
        ...
        const matched = azureVnetSupportedRegions.find(function (region) {
    ...
    function buildPromptTitle(prompt, fallbackLabel) {
        return AzureVnetModelCore.buildPromptTitle(prompt, fallbackLabel);
    }

    function inferFromPrompt(prompt, preset) {
        return AzureVnetModelCore.inferFromPrompt(prompt, preset);
    }
    ...
    function resolveCardIconHref(card) {
        if (!card.iconKey || !Object.prototype.hasOwnProperty.call(azureVnetIconSvgMap, card.iconKey)) {
            return '';
        }

        return buildSvgDataUri(azureVnetIconSvgMap[card.iconKey]);
    }
    ...
    function cloneLayoutOverrides(layoutOverrides) {
        return AzureVnetModelCore.cloneLayoutOverrides(layoutOverrides);
    }

    function cloneConnectorOverrides(connectorOverrides) {
        return AzureVnetModelCore.cloneConnectorOverrides(connectorOverrides);
    }
    ...
    function renderCardConnector(sourceCard, targetCard, options) {
        ...
        const markerId = resolvedOptions.active ? 'azureVnetArrowActive' : 'azureVnetArrow';
    ...
    function buildSvgMarkup(spec, layoutOverrides, connectorOverrides) {
        ...
        return {
            svgMarkup: [
                ...
                ']]></style>',
                '<marker id="azureVnetArrow" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto" markerUnits="strokeWidth">',
                '<path d="M 0 0 L 10 5 L 0 10 z" fill="#2563eb"></path>',
                '</marker>',
                '<marker id="azureVnetArrowActive" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto" markerUnits="strokeWidth">',
    ...
    function buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides) {
        return AzureVnetModelCore.buildExportPayload(spec, inventory, layoutOverrides, connectorOverrides, buildNotePayload(spec));
    }
    ...
    function renderInventory(inventory) {
        ...
        inventoryTableBody.innerHTML = sortedInventory.map(function (item, index) {
            return [
                ...
                '<td class="azure-vnet-table-action-cell">',
                '<button type="button" class="azure-vnet-row-copy" data-inventory-copy-row="' + escapeHtml(index) + '" aria-label="Copy inventory row ' + escapeHtml(item.inventoryIndex || index + 1) + '" title="Copy inventory row">',
    ...
    function renderOutputScore(spec) {
        ...
        outputStatus.innerHTML = [
            '<div class="azure-vnet-score-ring-card">',
            '<div class="azure-vnet-score-value" data-score-angle="' + escapeHtml(String(scorePayload.angle)) + 'deg" aria-label="Architecture score ' + escapeHtml(String(scorePayload.score)) + ' out of 100">',
            '<span class="azure-vnet-score-value-number">' + escapeHtml(String(scorePayload.score)) + '</span>',
            '<span class="azure-vnet-score-value-scale">/100</span>',
            '</div>',
            '<div class="azure-vnet-score-ring-label">' + escapeHtml(scorePayload.ringLabel) + '</div>',
            '</div>',
            '<div class="azure-vnet-score-copy">',
            '<div class="azure-vnet-score-kicker">Architecture Score</div>',
            '<div class="azure-vnet-score-summary">' + escapeHtml(scorePayload.band) + '</div>',
            '<div class="azure-vnet-score-detail">' + escapeHtml(scorePayload.detail) + '</div>',
            '<div class="azure-vnet-score-tags">',
            [
                '<span class="azure-vnet-score-tag azure-vnet-score-tag-status azure-vnet-score-tag-status-' + escapeHtml(scorePayload.badgeTone) + '">',
            ...
            scorePayload.tags.map(function (item) {
                return [
                    '<span class="azure-vnet-score-tag azure-vnet-score-tag-' + escapeHtml(item.tone) + '">',
        ...
        const scoreValue = outputStatus.querySelector('.azure-vnet-score-value');

        if (scoreValue) {
            scoreValue.style.setProperty('--azure-vnet-score-fill-angle', '0deg');

            window.requestAnimationFrame(function () {
                window.requestAnimationFrame(function () {
                    scoreValue.style.setProperty('--azure-vnet-score-fill-angle', String(scoreValue.dataset.scoreAngle || '0deg'));
                });
            });
        }
    }
    ...
    function resetToDefault() {
        applyPreset(azureVnetPresetCatalog[0].id, true);
    }
    ...
    function downloadSvg() {
        ...
        downloadFile('azure-vnet-architecture.svg', latestResult.svgMarkup, 'image/svg+xml;charset=utf-8');
    }
            ...
            image.onload = function () {
                ...
                if (context) {
                    ...
                    canvas.toBlob(function (blob) {
                        ...
                        downloadFile('azure-vnet-architecture.png', blob, 'image/png');
    ...
    function downloadJson() {
        ...
        downloadFile('azure-vnet-architecture.json', JSON.stringify(latestResult.exportPayload, null, 2), 'application/json;charset=utf-8');
    }
    ...
    presetInput.addEventListener('change', function () {
        applyPreset(String(presetInput.value || azureVnetPresetCatalog[0].id), true);
    });

    tabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateTab(String(button.dataset.tabTarget || 'azureVnetInventoryPanel'));
        });
    });
    ...
    configTabButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            activateConfigTab(String(button.dataset.configTabTarget || 'azureVnetNetworkConfigPanel'));
        });
    });
    ...
    document.addEventListener('keydown', function (event) {
        if (event.key === 'Escape' && stageShell.classList.contains('azure-vnet-stage-expanded')) {
            setStageExpanded(false);
        }
    });
    ...
    inventoryTableBody.addEventListener('click', function (event) {
        const button = event.target.closest('.azure-vnet-row-copy');
    ...
    document.addEventListener('click', function (event) {
        if (event.target.closest('.azure-vnet-custom-select')) {
            return;
        }
    ...
    activateTab('azureVnetInventoryPanel');
    activateConfigTab('azureVnetNetworkConfigPanel');
    updateFullscreenButton();
    applyStageZoom();
    updatePresetSelection();
    applyPreset(azureVnetPresetCatalog[0].id, true);
