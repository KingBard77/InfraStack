const AzureVnetModelCore = (function () {
    const toolId = 'azure-vnet-architecture';
    ...
    function buildImportedPayloadState(payload, presets) {
        ...
        if (payload.tool !== toolId) {
            return {
                error: 'The imported JSON is not a Visualizer Azure VNet Architecture workspace export.'
            };
        }
...
if (typeof globalThis !== 'undefined') {
    globalThis.AzureVnetModelCore = AzureVnetModelCore;
}

if (typeof module !== 'undefined' && module.exports) {
    module.exports = AzureVnetModelCore;
}
