...
<div class="content-card architecture-vpc-huawei-markdown-card architecture-vpc-huawei-markdown-card-citations">
  ...
  <table class="architecture-vpc-huawei-citation-table">
    ...
    <tbody>
      <tr id="architecture-vpc-huawei-ref-primary"><td>Website</td><td><a class="architecture-vpc-huawei-citation-backlink" href="#architecture-vpc-huawei-cite-primary"><span class="architecture-vpc-huawei-citation-inline">(Huawei Cloud, 2026a)</span></a></td><td>Huawei Cloud. (2026a). <em>What Is Virtual Private Cloud?</em> Retrieved May 24, 2026, from <a href="https://support.huaweicloud.com/intl/en-us/productdesc-vpc/en-us_topic_0013748729.html">https://support.huaweicloud.com/intl/en-us/productdesc-vpc/en-us_topic_0013748729.html</a></td></tr>
      <tr id="architecture-vpc-huawei-ref-method"><td>Website</td><td><a class="architecture-vpc-huawei-citation-backlink" href="#architecture-vpc-huawei-cite-method"><span class="architecture-vpc-huawei-citation-inline">(Huawei Cloud, 2026b)</span></a></td><td>Huawei Cloud. (2026b). <em>What Is NAT Gateway?</em> Retrieved May 24, 2026, from <a href="https://support.huaweicloud.com/intl/en-us/productdesc-natgateway/en-us_topic_0086739762.html">https://support.huaweicloud.com/intl/en-us/productdesc-natgateway/en-us_topic_0086739762.html</a></td></tr>
      <tr id="architecture-vpc-huawei-ref-review"><td>Website</td><td><a class="architecture-vpc-huawei-citation-backlink" href="#architecture-vpc-huawei-cite-review"><span class="architecture-vpc-huawei-citation-inline">(Huawei Cloud, 2026c)</span></a></td><td>Huawei Cloud. (2026c). <em>What Is an Enterprise Router?</em> Retrieved May 24, 2026, from <a href="https://support.huaweicloud.com/intl/en-us/productdesc-er/er_01_0002.html">https://support.huaweicloud.com/intl/en-us/productdesc-er/er_01_0002.html</a></td></tr>
    </tbody>
  </table>
</div>
