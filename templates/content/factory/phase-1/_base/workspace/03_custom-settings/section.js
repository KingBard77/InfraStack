...
(function attachBaseCustomSettingsSourceSection(global) {
    ...
    const source = {
        ...
        sourceBehaviours: [
            ...
            'uses one right-aligned arrow slot with a button surface for Custom disclosure and dropdown controls',
            'uses right-facing default arrows and down-facing open arrows instead of up-facing open arrows',
            'uses a CSS popup dropdown surface instead of browser-native select popups or inline card expansion',
            ...
            'provides explicit CSS hooks for arrow slots, popup dropdowns, radio cards, text fields, number fields, textareas, placeholders, CSS-drawn checkbox switches, grouped cards, and dashed info rows',
