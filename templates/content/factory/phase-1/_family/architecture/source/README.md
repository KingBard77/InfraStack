...
Final tools must not import these files at runtime. Use `templates/content/factory/phase-1/_family/architecture/workspace/` as the reusable section source.
