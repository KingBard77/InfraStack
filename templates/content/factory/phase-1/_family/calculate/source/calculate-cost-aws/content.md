...
__TOOL_TITLE__ is an InfraStack workspace for building a first-pass monthly AWS run-rate estimate from visible workload assumptions. It focuses on the spend drivers this workspace can model directly: <span class="__PREFIX__-term-accent">EC2</span>, <span class="__PREFIX__-term-accent">EBS</span>, <span class="__PREFIX__-term-accent">S3</span>, <span class="__PREFIX__-term-accent">Lambda</span>, <span class="__PREFIX__-term-accent">API Gateway</span>, shared internet egress, support uplift, contingency, and manual monthly adjustments. <a id="__PREFIX__-cite-primary" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-primary"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-a)</span></a> provides AWS Pricing Calculator for building service estimates, so this workspace keeps its result framed as a planning estimate rather than a bill.

<a id="__PREFIX__-cite-method" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-method"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-b)</span></a> publishes EC2 pricing around purchase options such as On-Demand, Savings Plans, Spot Instances, and capacity reservations, which is why the EC2 inputs stay visible for review.

<a id="__PREFIX__-cite-review" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-review"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-c)</span></a> prices Lambda around request and compute usage, so serverless line items should be checked against expected invocation volume and runtime before sharing the estimate.
...
<div class="__PREFIX__-markdown-table-wrap">
<table>
  <thead>
    <tr>
...
<h2 class="__PREFIX__-section-heading"><i class="bi bi-calculator" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The estimate notes stay tied to official AWS pricing sources. <a id="__PREFIX__-cite-technical-primary" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-primary"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-a)</span></a> anchors the calculator framing, and <a id="__PREFIX__-cite-technical-method" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-method"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-b)</span></a> anchors the EC2 purchase-model assumptions that appear in the service drivers below. <a id="__PREFIX__-cite-technical-review" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-review"><span class="__PREFIX__-citation-inline">Amazon Web Services (n.d.-c)</span></a> anchors the Lambda and serverless pricing review surface that should be reviewed before the estimate is shared.
...
<h3 class="__PREFIX__-technical-step-heading">1. Estimate model</h3>
...
<h3 class="__PREFIX__-technical-step-heading">2. Starter catalog and overrides</h3>
...
<h3 class="__PREFIX__-technical-step-heading">3. Service drivers</h3>
...
<h3 class="__PREFIX__-technical-step-heading">4. Formula boundaries</h3>
...
<h3 class="__PREFIX__-technical-step-heading">5. Review boundaries</h3>
...
<h3 class="__PREFIX__-technical-step-heading">6. How to read the estimate</h3>
...
<h3 class="__PREFIX__-technical-step-heading">7. Scenario discipline</h3>
...
<h3 class="__PREFIX__-technical-step-heading">8. Assumption hygiene</h3>
...
<h3 class="__PREFIX__-technical-step-heading">9. Export and handoff behavior</h3>
...
<h3 class="__PREFIX__-technical-step-heading">10. Practical review checklist</h3>
...
<h3 class="__PREFIX__-technical-step-heading">11. What the number should trigger</h3>
...
<pre class="__PREFIX__-prompt-pre"><code>Estimate a steady AWS application platform from the Steady application platform preset. Include 6 m7g.large EC2 instances running 730 hours with Savings Plan comparison, 900 GB gp3 EBS with 6000 IOPS and 250 MB/s throughput, 2 TB S3 storage, 600 GB S3 egress, 8 million REST API requests with 48 KB average response size, 600 GB shared egress, 10% support uplift, and 15% contingency.</code></pre>
...
<div class="content-card __PREFIX__-markdown-card __PREFIX__-markdown-card-prompt-tips __PREFIX__-markdown-card-input-tips">
...
<div class="content-card __PREFIX__-markdown-card __PREFIX__-markdown-card-how-to">
  <h2 class="__PREFIX__-section-heading"><i class="bi bi-list-check __PREFIX__-section-heading-icon" aria-hidden="true"></i><span>How To Use</span></h2>
  ...
  <details class="tool-guidance-item" open>
    ...
    <div class="tool-guidance-answer">
      <p>Choose the closest __TOOL_TITLE__ preset, then name the estimate or scenario so exported results can be traced back to the workload being reviewed.</p>
    </div>
  </details>
...
<div class="content-card __PREFIX__-markdown-card __PREFIX__-markdown-card-export">
  <h2 class="__PREFIX__-section-heading"><i class="bi bi-download __PREFIX__-section-heading-icon" aria-hidden="true"></i><span>Export Notes</span></h2>
...
<table class="__PREFIX__-citation-table">
  ...
  <tbody>
    <tr id="__PREFIX__-ref-primary">
      ...
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-primary"><span class="__PREFIX__-citation-inline">(Amazon Web Services, n.d.-a)</span></a></td>
    ...
    <tr id="__PREFIX__-ref-method">
      <td>Pricing page</td>
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-method"><span class="__PREFIX__-citation-inline">(Amazon Web Services, n.d.-b)</span></a></td>
    ...
    <tr id="__PREFIX__-ref-review">
      <td>Pricing page</td>
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-review"><span class="__PREFIX__-citation-inline">(Amazon Web Services, n.d.-c)</span></a></td>
