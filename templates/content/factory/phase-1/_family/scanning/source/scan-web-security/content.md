...
__TOOL_TITLE__ is an InfraStack security workspace for checking a public web endpoint from the application server and turning visible response behavior into reviewable findings. <a id="__PREFIX__-cite-primary" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-primary"><span class="__PREFIX__-citation-inline">OWASP (n.d.)</span></a> organizes common HTTP security response headers for browser-facing hardening, so this scanner treats headers as review evidence rather than proof of application security.

<a id="__PREFIX__-cite-method" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-method"><span class="__PREFIX__-citation-inline">IETF (2012)</span></a> standardizes HTTP Strict Transport Security, which is why HSTS appears as a separate HTTPS retention finding.

<a id="__PREFIX__-cite-review" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-review"><span class="__PREFIX__-citation-inline">IETF (2022)</span></a> defines HTTP semantics for request and response behavior, so server-side header evidence still needs application-context review before remediation is assigned.

It inspects the signals that are exposed at the edge: <span class="__PREFIX__-term-accent">HTTPS</span>, redirect posture, HSTS, CSP, frame protection, MIME sniffing protection, referrer and permissions policy, disclosure headers, cookie attributes, CORS exposure, and well-known files such as <code>security.txt</code> and <code>robots.txt</code>.
...
<h2 class="__PREFIX__-section-heading"><i class="bi bi-shield-lock" aria-hidden="true"></i><span>Technical Details</span></h2>
...
The technical checks stay tied to security-header and protocol sources. <a id="__PREFIX__-cite-technical-primary" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-primary"><span class="__PREFIX__-citation-inline">OWASP (n.d.)</span></a> anchors the response-header review scope, <a id="__PREFIX__-cite-technical-method" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-method"><span class="__PREFIX__-citation-inline">IETF (2012)</span></a> anchors HSTS as an HTTPS retention signal, and <a id="__PREFIX__-cite-technical-review" class="__PREFIX__-citation-link" href="#__PREFIX__-ref-review"><span class="__PREFIX__-citation-inline">IETF (2022)</span></a> anchors the request and response semantics that make method, redirect, and final URL context matter.
...
<h3 class="__PREFIX__-technical-step-heading">1. Server-side request model</h3>
...
<h3 class="__PREFIX__-technical-step-heading">2. Request controls</h3>
...
<h3 class="__PREFIX__-technical-step-heading">3. Finding classification</h3>
...
<h3 class="__PREFIX__-technical-step-heading">4. Header and cookie review</h3>
...
<h3 class="__PREFIX__-technical-step-heading">5. CORS and public file probes</h3>
...
<h3 class="__PREFIX__-technical-step-heading">6. Visible surface inventory</h3>
...
<h3 class="__PREFIX__-technical-step-heading">7. Scope boundaries</h3>
...
<h3 class="__PREFIX__-technical-step-heading">8. How to read the result</h3>
...
<h3 class="__PREFIX__-technical-step-heading">9. Evidence discipline</h3>
...
<h3 class="__PREFIX__-technical-step-heading">10. Request option boundaries</h3>
...
<h3 class="__PREFIX__-technical-step-heading">11. Public target and authorization rules</h3>
...
<h3 class="__PREFIX__-technical-step-heading">12. Export and remediation workflow</h3>
...
<h3 class="__PREFIX__-technical-step-heading">13. Practical review checklist</h3>
...
<h3 class="__PREFIX__-technical-step-heading">14. Change tracking</h3>
...
<h3 class="__PREFIX__-technical-step-heading">15. Human review boundary</h3>
...
<h2 class="__PREFIX__-section-heading"><i class="bi bi-terminal" aria-hidden="true"></i><span>Example Scan Inputs</span></h2>
...
<pre class="__PREFIX__-example-input __PREFIX__-command-pre"><code>Target: https://example.com
Method: HEAD
Follow redirects: on
Validate TLS: on
...
<details class="__PREFIX__-input-note" open>
  <summary>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-closed">Show scan use</span>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-open">Hide scan use</span>
    <button type="button" class="__PREFIX__-input-copy-btn __PREFIX__-command-copy-btn" data-scan-input-copy-index="0">
...
<pre class="__PREFIX__-example-input __PREFIX__-command-pre"><code>Target: https://www.example.com
Method: GET
...
<details class="__PREFIX__-input-note">
  <summary>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-closed">Show scan use</span>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-open">Hide scan use</span>
    <button type="button" class="__PREFIX__-input-copy-btn __PREFIX__-command-copy-btn" data-scan-input-copy-index="1">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy input</span>
    </button>
  </summary>
...
<pre class="__PREFIX__-example-input __PREFIX__-command-pre"><code>Target: http://example.com
Method: HEAD
Follow redirects: on
Validate TLS: on
...
<details class="__PREFIX__-input-note">
  <summary>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-closed">Show scan use</span>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-open">Hide scan use</span>
    <button type="button" class="__PREFIX__-input-copy-btn __PREFIX__-command-copy-btn" data-scan-input-copy-index="2">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy input</span>
    </button>
  </summary>
...
<pre class="__PREFIX__-example-input __PREFIX__-command-pre"><code>Target: https://app.example.com
Method: GET
User-Agent profile: Desktop browser
Follow redirects: on
Validate TLS: on
...
<details class="__PREFIX__-input-note __PREFIX__-input-note-last">
  <summary>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-closed">Show scan use</span>
    <span class="__PREFIX__-input-note-label __PREFIX__-input-note-label-open">Hide scan use</span>
    <button type="button" class="__PREFIX__-input-copy-btn __PREFIX__-command-copy-btn" data-scan-input-copy-index="3">
      <i class="bi bi-clipboard" aria-hidden="true"></i>
      <span>Copy input</span>
    </button>
  </summary>
...
<div class="content-card __PREFIX__-markdown-card __PREFIX__-markdown-card-interpretation __PREFIX__-markdown-card-input-tips">

<h2 class="__PREFIX__-section-heading"><i class="bi bi-lightbulb" aria-hidden="true"></i><span>Interpretation Notes</span></h2>
...
<table class="__PREFIX__-citation-table">
  ...
  <tbody>
    <tr id="__PREFIX__-ref-primary">
      ...
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-primary"><span class="__PREFIX__-citation-inline">(OWASP, n.d.)</span></a></td>
    ...
    <tr id="__PREFIX__-ref-method">
      <td>RFC</td>
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-method"><span class="__PREFIX__-citation-inline">(IETF, 2012)</span></a></td>
    ...
    <tr id="__PREFIX__-ref-review">
      <td>RFC</td>
      <td><a class="__PREFIX__-citation-backlink" href="#__PREFIX__-cite-review"><span class="__PREFIX__-citation-inline">(IETF, 2022)</span></a></td>
