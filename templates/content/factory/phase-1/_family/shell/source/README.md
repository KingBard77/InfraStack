...
Final tools must not import these files at runtime. Use `templates/content/factory/phase-1/_family/shell/workspace/` as the reusable section source. Reapplying the shell family to runtime packages means structural, visual, and runtime parity with that workspace source, not marker coverage, source markers, old snapshot equivalence, or copied support text.
