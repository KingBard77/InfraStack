...
```text
templates/content/factory/phase-1/_family/shell/source/tool.html.twig
templates/content/factory/phase-1/_family/shell/source/custom.css
templates/content/factory/phase-1/_family/shell/source/custom.js
```
...
1. Read `templates/content/factory/phase-1/_family/shell/README.md`.
2. Read `templates/content/factory/phase-1/_family/shell/manifest.yml`.
3. Read this workspace source.
4. Read `templates/content/factory/phase-1/_family/shell/workspace/manifest.yml`.
...
7. Read `templates/content/factory/phase-2/_content/scaffold/README.md`.
8. Read the phase-2 content section folders under `templates/content/factory/phase-2/_content/sections/`.
