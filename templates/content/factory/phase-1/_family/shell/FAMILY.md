...
snapshot: templates/content/factory/phase-1/_family/shell/source/
workspace: templates/content/factory/phase-1/_family/shell/workspace/
model-core: templates/content/factory/phase-1/_family/shell/workspace/assets/bin/model-core.js
```
...
- Keep shell support-content design sourced through phase-2 content sections and composed workspace sources, not manually copied from one final tool to another.
