...
11. `templates/content/family/shell/workspace/manifest.yml`
12. relevant shell workspace section folders under `templates/content/family/shell/workspace/`
...
The shell family adapts the shared main content sections:
