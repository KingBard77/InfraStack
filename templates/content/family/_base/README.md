# InfraStack Base Workspace Foundation

## Purpose

`_base` defines shared workspace structure used by multiple InfraStack families.

It is not a runtime family, catalogue family, or final tool package. It is a reusable source foundation for workspace shape, section rhythm, control framing, and neutral interaction shells.
