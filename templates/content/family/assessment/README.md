...
8. `templates/content/family/assessment/README.md`
9. `templates/content/family/assessment/manifest.yml`
10. `templates/content/family/assessment/workspace/README.md`
11. `templates/content/family/assessment/workspace/manifest.yml`
...
The assessment family adapts the shared main content sections:
