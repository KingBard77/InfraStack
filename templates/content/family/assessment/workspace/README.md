...
1. Read `templates/content/family/assessment/README.md`.
2. Read `templates/content/family/assessment/manifest.yml`.
3. Read this workspace source.
4. Read `templates/content/family/assessment/workspace/manifest.yml`.
5. Inspect relevant section files under `templates/content/family/assessment/workspace/`.
6. Read `templates/content/main/scaffold/README.md`.
7. Read shared main content sections under `templates/content/main/sections/content/`.
