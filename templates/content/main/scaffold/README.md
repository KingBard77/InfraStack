...
`templates/content/main/sections/` owns reusable content section delivery.
...
`assets/img/post.html.twig` is also the platform fallback visual source when a tool does not yet have a tool-local post visual. Do not recreate `templates/content/main/tool-post-visual.html.twig`.
...
`templates/content/main/sections/` owns shared content sections.
Family `workspace/` folders own family-specific workspace sections.

Do not create duplicated `sections/` folders under `templates/content/family/<family>/`.
...
3. Read this scaffold README and `templates/content/main/sections/manifest.yml`.
